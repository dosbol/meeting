...
var len__28366__auto___42364 = arguments.length;
var i__28367__auto___42365 = (0);
while(true){
if((i__28367__auto___42365 < len__28366__auto___42364)){
args__28373__auto__.push((arguments[i__28367__auto___42365]));

var G__42366 = (i__28367__auto___42365 + (1));
i__28367__auto___42365 = G__42366;
continue;
} else {
}
break;
...
return re_com.modal_panel.modal_panel.cljs$core$IFn$_invoke$arity$variadic(argseq__28374__auto__);
});

re_com.modal_panel.modal_panel.cljs$core$IFn$_invoke$arity$variadic = (function (p__42361){
var map__42362 = p__42361;
var map__42362__$1 = ((((!((map__42362 == null)))?((((map__42362.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42362.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42362):map__42362);
var args = map__42362__$1;
var child = cljs.core.get.call(null,map__42362__$1,new cljs.core.Keyword(null,"child","child",623967545));
var wrap_nicely_QMARK_ = cljs.core.get.call(null,map__42362__$1,new cljs.core.Keyword(null,"wrap-nicely?","wrap-nicely?",85012288),true);
var backdrop_color = cljs.core.get.call(null,map__42362__$1,new cljs.core.Keyword(null,"backdrop-color","backdrop-color",1921200717),"black");
var backdrop_opacity = cljs.core.get.call(null,map__42362__$1,new cljs.core.Keyword(null,"backdrop-opacity","backdrop-opacity",1467395653),0.6);
var backdrop_on_click = cljs.core.get.call(null,map__42362__$1,new cljs.core.Keyword(null,"backdrop-on-click","backdrop-on-click",-1460240426));
var class$ = cljs.core.get.call(null,map__42362__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__42362__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__42362__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
return null;
});})(map__42362,map__42362__$1,args,child,wrap_nicely_QMARK_,backdrop_color,backdrop_opacity,backdrop_on_click,class$,style,attr))
...
re_com.modal_panel.modal_panel.cljs$lang$applyTo = (function (seq42360){
return re_com.modal_panel.modal_panel.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42360));
});


//# sourceMappingURL=modal_panel.js.map?rel=1515350526381
