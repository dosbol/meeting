...
return (function (p1__42255_SHARP_,p2__42256_SHARP_){
return cljs.core.assoc.call(null,p1__42255_SHARP_,p2__42256_SHARP_,reagent.core.atom.call(null,false));
});})(tour_map))
,tour_map,tour_spec);
});
/**
...
return cljs.core.doall.call(null,(function (){var iter__28004__auto__ = (function re_com$tour$initialise_tour_$_iter__42257(s__42258){
...
var c__28002__auto__ = cljs.core.chunk_first.call(null,s__42258__$2);
var size__28003__auto__ = cljs.core.count.call(null,c__28002__auto__);
var b__42260 = cljs.core.chunk_buffer.call(null,size__28003__auto__);
if((function (){var i__42259 = (0);
while(true){
if((i__42259 < size__28003__auto__)){
var step = cljs.core._nth.call(null,c__28002__auto__,i__42259);
cljs.core.chunk_append.call(null,b__42260,cljs.core.reset_BANG_.call(null,step.call(null,tour),false));

var G__42261 = (i__42259 + (1));
i__42259 = G__42261;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42260),re_com$tour$initialise_tour_$_iter__42257.call(null,cljs.core.chunk_rest.call(null,s__42258__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42260),null);
}
} else {
var step = cljs.core.first.call(null,s__42258__$2);
return cljs.core.cons.call(null,cljs.core.reset_BANG_.call(null,step.call(null,tour),false),re_com$tour$initialise_tour_$_iter__42257.call(null,cljs.core.rest.call(null,s__42258__$2)));
}
} else {
return null;
}
...
return iter__28004__auto__.call(null,new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
})());
});
/**
...
//# sourceMappingURL=tour.js.map?rel=1514660180841
