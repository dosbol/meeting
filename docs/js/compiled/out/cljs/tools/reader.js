...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__30893 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30893,ch);
...
if(("\\" === ch__$1)){
var ch_30894__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_30894__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_30894__$2);
} else {
}

var G__30895 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__30895;
continue;
}
}
...
var vec__30903 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30903,(0),null);
var start_column = cljs.core.nth.call(null,vec__30903,(1),null);
...
var G__30906 = cljs.core.conj_BANG_.call(null,a,form);
a = G__30906;
continue;
}
}
...
var vec__30908 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30908,(0),null);
var start_column = cljs.core.nth.call(null,vec__30908,(1),null);
...
var vec__30911 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30911,(0),null);
var end_column = cljs.core.nth.call(null,vec__30911,(1),null);
...
var vec__30914 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30914,(0),null);
var start_column = cljs.core.nth.call(null,vec__30914,(1),null);
...
var sb = (function (){var G__30926 = (new goog.string.StringBuffer());
G__30926.append(initch);
...
var G__30928 = (function (){var G__30927 = sb;
G__30927.append(ch);

return G__30927;
})();
var G__30929 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__30928;
ch = G__30929;
continue;
}
...
switch (G__30932) {
case "\\":
var G__30936 = (function (){var G__30933 = sb;
G__30933.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__30933;
})();
var G__30937 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30936;
ch = G__30937;
continue;
...
break;
default:
var G__30938 = (function (){var G__30934 = sb;
G__30934.append(ch);

return G__30934;
})();
var G__30939 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30938;
ch = G__30939;
continue;
...
var vec__30940 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30940,(0),null);
var end_column = cljs.core.nth.call(null,vec__30940,(1),null);
...
var vec__30943 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30943,(0),null);
var column = cljs.core.nth.call(null,vec__30943,(1),null);
...
var vec__30948 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30948,(0),null);
var column = cljs.core.nth.call(null,vec__30948,(1),null);
...
var line = cljs.core.nth.call(null,vec__30953,(0),null);
var column = cljs.core.nth.call(null,vec__30953,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__30964 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__30964,true,null,opts,pending_forms);
...
var G__30966 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__30966,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__30966,rdr,first_line);
...
var G__30970 = matched;
var G__30971 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__30970;
finished = G__30971;
continue;
} else {
...
var _STAR_suppress_read_STAR_30972 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_30972;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env30973 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__30974 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30974,"(");
...
var G__30975 = (i + (1));
var G__30976 = cljs.core.conj_BANG_.call(null,args,(function (){var or__28286__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env30973;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__30977 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__30977);
...
var G__30978 = cljs.core.next.call(null,s__$1);
var G__30979 = ret;
s__$1 = G__30978;
r = G__30979;
continue;
...
var G__30980 = cljs.core.next.call(null,s);
var G__30981 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__30980;
key_vals = G__30981;
continue;
} else {
...
var gensym_env30985 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env30985;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__30986 = token;
var G__30986__$1 = (((G__30986 == null))?null:cljs.core.subs.call(null,G__30986,(1)));
var G__30986__$2 = (((G__30986__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__30986__$1));
var G__30986__$3 = (((G__30986__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__30986__$2));
var G__30986__$4 = (((G__30986__$3 == null))?null:cljs.core.symbol.call(null,G__30986__$3));
if((G__30986__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__30986__$4);
}
})():(function (){var G__30987 = token;
var G__30987__$1 = (((G__30987 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__30987));
if((G__30987__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__30987__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
var eof = cljs.core.get.call(null,map__30999__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1513400427161
