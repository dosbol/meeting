...
var len__28364__auto___45817 = arguments.length;
var i__28365__auto___45818 = (0);
while(true){
if((i__28365__auto___45818 < len__28364__auto___45817)){
args__28371__auto__.push((arguments[i__28365__auto___45818]));

var G__45819 = (i__28365__auto___45818 + (1));
i__28365__auto___45818 = G__45819;
continue;
} else {
}
break;
...
return cljs.core.reset_BANG_.call(null,new cljs.core.Keyword(null,"id-handler","id-handler",1013135509).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.data.re_frame_data)),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__45814_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([cljs.core.first.call(null,p1__45814_SHARP_)],[cljs.core.deref.call(null,cljs.core.second.call(null,p1__45814_SHARP_))]);
}),cljs.core.remove.call(null,(function (p1__45815_SHARP_){
return (cljs.core._EQ_.call(null,cljs.core.first.call(null,cljs.core.ffirst.call(null,p1__45815_SHARP_)),new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709))) || ((cljs.core.second.call(null,p1__45815_SHARP_) == null));
}),cljs.core.deref.call(null,re_frame.subs.query__GT_reaction)))));
});

re_frisk.core.re_frame_sub.cljs$lang$maxFixedArity = (0);

re_frisk.core.re_frame_sub.cljs$lang$applyTo = (function (seq45816){
return re_frisk.core.re_frame_sub.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45816));
});
...
var args__28371__auto__ = [];
var len__28364__auto___45825 = arguments.length;
var i__28365__auto___45826 = (0);
while(true){
if((i__28365__auto___45826 < len__28364__auto___45825)){
args__28371__auto__.push((arguments[i__28365__auto___45826]));

var G__45827 = (i__28365__auto___45826 + (1));
i__28365__auto___45826 = G__45827;
continue;
} else {
}
break;
...
re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__45821){
var vec__45822 = p__45821;
var opts = cljs.core.nth.call(null,vec__45822,(0),null);
...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709),((function (vec__45822,opts){
return (function (db,_){
return db;
});})(vec__45822,opts))
);
} else {
re_frame.core.register_sub.call(null,new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709),((function (vec__45822,opts){
return (function (db,_){
return reagent.ratom.make_reaction.call(null,((function (vec__45822,opts){
return (function (){
...
re_frisk.core.enable_re_frisk_BANG_.cljs$lang$applyTo = (function (seq45820){
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45820));
});

re_frisk.core.enable_frisk_BANG_ = (function re_frisk$core$enable_frisk_BANG_(var_args){
var args__28371__auto__ = [];
var len__28364__auto___45829 = arguments.length;
var i__28365__auto___45830 = (0);
while(true){
if((i__28365__auto___45830 < len__28364__auto___45829)){
args__28371__auto__.push((arguments[i__28365__auto___45830]));

var G__45831 = (i__28365__auto___45830 + (1));
i__28365__auto___45830 = G__45831;
continue;
} else {
}
break;
...
re_frisk.core.enable_frisk_BANG_.cljs$lang$applyTo = (function (seq45828){
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45828));
});
...
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"views","views",1450155487),view,new cljs.core.Keyword(null,"subs","subs",-186681991)], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__45832_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([p1__45832_SHARP_],[re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__45832_SHARP_], null))]);
}),subs)));

var seq__45833 = cljs.core.seq.call(null,subs);
var chunk__45834 = null;
var count__45835 = (0);
var i__45836 = (0);
while(true){
if((i__45836 < count__45835)){
var s = cljs.core._nth.call(null,chunk__45834,i__45836);
...
var G__45837 = seq__45833;
var G__45838 = chunk__45834;
var G__45839 = count__45835;
var G__45840 = (i__45836 + (1));
seq__45833 = G__45837;
chunk__45834 = G__45838;
count__45835 = G__45839;
i__45836 = G__45840;
continue;
} else {
...
var c__28034__auto__ = cljs.core.chunk_first.call(null,seq__45833__$1);
var G__45841 = cljs.core.chunk_rest.call(null,seq__45833__$1);
var G__45842 = c__28034__auto__;
var G__45843 = cljs.core.count.call(null,c__28034__auto__);
var G__45844 = (0);
seq__45833 = G__45841;
chunk__45834 = G__45842;
count__45835 = G__45843;
i__45836 = G__45844;
continue;
} else {
var s = cljs.core.first.call(null,seq__45833__$1);
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"subs","subs",-186681991),s], null),re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null)));

var G__45845 = cljs.core.next.call(null,seq__45833__$1);
var G__45846 = null;
var G__45847 = (0);
var G__45848 = (0);
seq__45833 = G__45845;
chunk__45834 = G__45846;
count__45835 = G__45847;
i__45836 = G__45848;
continue;
}
} else {
...
})().call(null,new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246),(function (_,p__45849){
var vec__45850 = p__45849;
var ___$1 = cljs.core.nth.call(null,vec__45850,(0),null);
var value = cljs.core.nth.call(null,vec__45850,(1),null);
return value;
}));

//# sourceMappingURL=core.js.map?rel=1515054969406
