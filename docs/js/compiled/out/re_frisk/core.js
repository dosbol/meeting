...
return cljs.core.reset_BANG_.call(null,new cljs.core.Keyword(null,"id-handler","id-handler",1013135509).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.data.re_frame_data)),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__45330_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([cljs.core.first.call(null,p1__45330_SHARP_)],[cljs.core.deref.call(null,cljs.core.second.call(null,p1__45330_SHARP_))]);
}),cljs.core.remove.call(null,(function (p1__45331_SHARP_){
return (cljs.core._EQ_.call(null,cljs.core.first.call(null,cljs.core.ffirst.call(null,p1__45331_SHARP_)),new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709))) || ((cljs.core.second.call(null,p1__45331_SHARP_) == null));
}),cljs.core.deref.call(null,re_frame.subs.query__GT_reaction)))));
});

re_frisk.core.re_frame_sub.cljs$lang$maxFixedArity = (0);

re_frisk.core.re_frame_sub.cljs$lang$applyTo = (function (seq45332){
return re_frisk.core.re_frame_sub.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45332));
});
...
var args__29462__auto__ = [];
var len__29455__auto___45341 = arguments.length;
var i__29456__auto___45342 = (0);
while(true){
if((i__29456__auto___45342 < len__29455__auto___45341)){
args__29462__auto__.push((arguments[i__29456__auto___45342]));

var G__45343 = (i__29456__auto___45342 + (1));
i__29456__auto___45342 = G__45343;
continue;
} else {
}
break;
...
re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__45337){
var vec__45338 = p__45337;
var opts = cljs.core.nth.call(null,vec__45338,(0),null);
...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709),((function (vec__45338,opts){
return (function (db,_){
return db;
});})(vec__45338,opts))
);
} else {
re_frame.core.register_sub.call(null,new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709),((function (vec__45338,opts){
return (function (db,_){
return reagent.ratom.make_reaction.call(null,((function (vec__45338,opts){
return (function (){
...
re_frisk.core.enable_re_frisk_BANG_.cljs$lang$applyTo = (function (seq45336){
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45336));
});

re_frisk.core.enable_frisk_BANG_ = (function re_frisk$core$enable_frisk_BANG_(var_args){
var args__29462__auto__ = [];
var len__29455__auto___45345 = arguments.length;
var i__29456__auto___45346 = (0);
while(true){
if((i__29456__auto___45346 < len__29455__auto___45345)){
args__29462__auto__.push((arguments[i__29456__auto___45346]));

var G__45347 = (i__29456__auto___45346 + (1));
i__29456__auto___45346 = G__45347;
continue;
} else {
}
break;
...
re_frisk.core.enable_frisk_BANG_.cljs$lang$applyTo = (function (seq45344){
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45344));
});
...
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"views","views",1450155487),view,new cljs.core.Keyword(null,"subs","subs",-186681991)], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__45348_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([p1__45348_SHARP_],[re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__45348_SHARP_], null))]);
}),subs)));

var seq__45349 = cljs.core.seq.call(null,subs);
var chunk__45350 = null;
var count__45351 = (0);
var i__45352 = (0);
while(true){
if((i__45352 < count__45351)){
var s = cljs.core._nth.call(null,chunk__45350,i__45352);
...
var G__45353 = seq__45349;
var G__45354 = chunk__45350;
var G__45355 = count__45351;
var G__45356 = (i__45352 + (1));
seq__45349 = G__45353;
chunk__45350 = G__45354;
count__45351 = G__45355;
i__45352 = G__45356;
continue;
} else {
...
var c__29125__auto__ = cljs.core.chunk_first.call(null,seq__45349__$1);
var G__45357 = cljs.core.chunk_rest.call(null,seq__45349__$1);
var G__45358 = c__29125__auto__;
var G__45359 = cljs.core.count.call(null,c__29125__auto__);
var G__45360 = (0);
seq__45349 = G__45357;
chunk__45350 = G__45358;
count__45351 = G__45359;
i__45352 = G__45360;
continue;
} else {
var s = cljs.core.first.call(null,seq__45349__$1);
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"subs","subs",-186681991),s], null),re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null)));

var G__45361 = cljs.core.next.call(null,seq__45349__$1);
var G__45362 = null;
var G__45363 = (0);
var G__45364 = (0);
seq__45349 = G__45361;
chunk__45350 = G__45362;
count__45351 = G__45363;
i__45352 = G__45364;
continue;
}
} else {
...
})().call(null,new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246),(function (_,p__45365){
var vec__45366 = p__45365;
var ___$1 = cljs.core.nth.call(null,vec__45366,(0),null);
var value = cljs.core.nth.call(null,vec__45366,(1),null);
return value;
}));

//# sourceMappingURL=core.js.map?rel=1513190832951
