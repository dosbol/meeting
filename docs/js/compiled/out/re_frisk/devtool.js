...
re_frisk.devtool.ie_QMARK_ = (function (){var or__27196__auto__ = cljs.core.re_find.call(null,/MSIE /,re_frisk.devtool.ua);
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
var or__27196__auto____$1 = cljs.core.re_find.call(null,/Trident\//,re_frisk.devtool.ua);
...
var expand_by_default = cljs.core.reduce.call(null,(function (p1__45798_SHARP_,p2__45799_SHARP_){
return cljs.core.assoc_in.call(null,p1__45798_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__45799_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
...
var map__45800 = new cljs.core.Keyword(null,"prefs","prefs",-1818938470).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.data.deb_data));
...
var ext_height = cljs.core.get.call(null,map__45800__$1,new cljs.core.Keyword(null,"ext_height","ext_height",-46169089));
var ext_width = cljs.core.get.call(null,map__45800__$1,new cljs.core.Keyword(null,"ext_width","ext_width",925500566));
var w = window.open("","Debugger",["width=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__27196__auto__ = ext_width;
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
return (800);
}
})()),",height=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__27196__auto__ = ext_height;
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
return (800);
...
(w["onload"] = ((function (map__45800,map__45800__$1,ext_height,ext_width,w,d){
return (function (){
return re_frisk.devtool.mount.call(null,w,d);
});})(map__45800,map__45800__$1,ext_height,ext_width,w,d))
);
...
var len__28365__auto___45805 = arguments.length;
var i__28366__auto___45806 = (0);
while(true){
if((i__28366__auto___45806 < len__28365__auto___45805)){
args__28372__auto__.push((arguments[i__28366__auto___45806]));

var G__45807 = (i__28366__auto___45806 + (1));
i__28366__auto___45806 = G__45807;
continue;
} else {
}
break;
...
return re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(argseq__28373__auto__);
});

re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic = (function (data){
var expand_by_default = cljs.core.reduce.call(null,(function (p1__45802_SHARP_,p2__45803_SHARP_){
return cljs.core.assoc_in.call(null,p1__45802_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__45803_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.range.call(null,cljs.core.count.call(null,data)));
var state_atom = reagent.core.atom.call(null,expand_by_default);
return ((function (expand_by_default,state_atom){
return (function() { 
var G__45808__delegate = function (data__$1){
...
while (G__45809__i < G__45809__a.length) {G__45809__a[G__45809__i] = arguments[G__45809__i + 0]; ++G__45809__i;}
  data__$1 = new cljs.core.IndexedSeq(G__45809__a,0,null);
} 
return G__45808__delegate.call(this,data__$1);};
G__45808.cljs$lang$maxFixedArity = 0;
G__45808.cljs$lang$applyTo = (function (arglist__45810){
var data__$1 = cljs.core.seq(arglist__45810);
return G__45808__delegate(data__$1);
});
...
re_frisk.devtool.re_frisk_panel.cljs$lang$applyTo = (function (seq45804){
return re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45804));
});

re_frisk.devtool.re_frisk_shell = (function re_frisk$devtool$re_frisk_shell(p__45811){
...
var x = cljs.core.get.call(null,map__45812__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.call(null,map__45812__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var width = cljs.core.get.call(null,map__45812__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__45812__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
var height__$1 = (cljs.core.truth_((function (){var and__27184__auto__ = re_frisk.devtool.ie_QMARK_;
if(cljs.core.truth_(and__27184__auto__)){
...
return ((function (style,height__$1,style__$1,style__$2,map__45812,map__45812__$1,x,y,width,height){
return (function (_){
...
});})(style,height__$1,style__$1,style__$2,map__45812,map__45812__$1,x,y,width,height))
...
//# sourceMappingURL=devtool.js.map?rel=1514660202152
