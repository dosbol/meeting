...
return (new CustomEvent(event_name,(function (){var obj37134 = {"detail":data};
return obj37134;
})()));
} else {
...
var f = (function (){var pred__37141 = cljs.core._EQ_;
var expr__37142 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37141.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37142))){
return ((function (pred__37141,expr__37142){
return (function (p1__37135_SHARP_){
return console.warn(p1__37135_SHARP_);
});
;})(pred__37141,expr__37142))
} else {
if(cljs.core.truth_(pred__37141.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37142))){
return ((function (pred__37141,expr__37142){
return (function (p1__37136_SHARP_){
return console.debug(p1__37136_SHARP_);
});
;})(pred__37141,expr__37142))
} else {
if(cljs.core.truth_(pred__37141.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37142))){
return ((function (pred__37141,expr__37142){
return (function (p1__37137_SHARP_){
return console.error(p1__37137_SHARP_);
});
;})(pred__37141,expr__37142))
} else {
return ((function (pred__37141,expr__37142){
return (function (p1__37138_SHARP_){
return console.log(p1__37138_SHARP_);
});
;})(pred__37141,expr__37142))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37145){
...
var opts = map__37146__$1;
var eval_fn = cljs.core.get.call(null,map__37146__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37148_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37150,(0),null);
var v = cljs.core.nth.call(null,vec__37150,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1517373780963
