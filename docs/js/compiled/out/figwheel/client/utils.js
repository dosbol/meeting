...
return (new CustomEvent(event_name,(function (){var obj37079 = {"detail":data};
return obj37079;
})()));
} else {
...
var f = (function (){var pred__37086 = cljs.core._EQ_;
var expr__37087 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37086.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37087))){
return ((function (pred__37086,expr__37087){
return (function (p1__37080_SHARP_){
return console.warn(p1__37080_SHARP_);
});
;})(pred__37086,expr__37087))
} else {
if(cljs.core.truth_(pred__37086.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37087))){
return ((function (pred__37086,expr__37087){
return (function (p1__37081_SHARP_){
return console.debug(p1__37081_SHARP_);
});
;})(pred__37086,expr__37087))
} else {
if(cljs.core.truth_(pred__37086.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37087))){
return ((function (pred__37086,expr__37087){
return (function (p1__37082_SHARP_){
return console.error(p1__37082_SHARP_);
});
;})(pred__37086,expr__37087))
} else {
return ((function (pred__37086,expr__37087){
return (function (p1__37083_SHARP_){
return console.log(p1__37083_SHARP_);
});
;})(pred__37086,expr__37087))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37090){
...
var eval_fn = cljs.core.get.call(null,map__37091__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37093_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37095,(0),null);
...
}catch (e37100){if((e37100 instanceof Error)){
var e = e37100;
return not_found;
} else {
throw e37100;
...
//# sourceMappingURL=utils.js.map?rel=1515855009645
