...
var or__27196__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37061 = {"detail":data};
return obj37061;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27184__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27184__auto__)){
var and__27184__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37068 = cljs.core._EQ_;
var expr__37069 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37068.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37069))){
return ((function (pred__37068,expr__37069){
return (function (p1__37062_SHARP_){
return console.warn(p1__37062_SHARP_);
});
;})(pred__37068,expr__37069))
} else {
if(cljs.core.truth_(pred__37068.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37069))){
return ((function (pred__37068,expr__37069){
return (function (p1__37063_SHARP_){
return console.debug(p1__37063_SHARP_);
});
;})(pred__37068,expr__37069))
} else {
if(cljs.core.truth_(pred__37068.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37069))){
return ((function (pred__37068,expr__37069){
return (function (p1__37064_SHARP_){
return console.error(p1__37064_SHARP_);
});
;})(pred__37068,expr__37069))
} else {
return ((function (pred__37068,expr__37069){
return (function (p1__37065_SHARP_){
return console.log(p1__37065_SHARP_);
});
;})(pred__37068,expr__37069))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37072){
var map__37073 = p__37072;
var map__37073__$1 = ((((!((map__37073 == null)))?((((map__37073.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37073.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__37073):map__37073);
var opts = map__37073__$1;
var eval_fn = cljs.core.get.call(null,map__37073__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37075_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37077,(0),null);
...
if(cljs.core.truth_((function (){var and__27184__auto__ = typeof localStorage !== 'undefined';
...
}catch (e37082){if((e37082 instanceof Error)){
var e = e37082;
return not_found;
} else {
throw e37082;
...
//# sourceMappingURL=utils.js.map?rel=1514660151602
