...
return (new CustomEvent(event_name,(function (){var obj37076 = {"detail":data};
return obj37076;
})()));
} else {
...
var f = (function (){var pred__37083 = cljs.core._EQ_;
var expr__37084 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37083.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37084))){
return ((function (pred__37083,expr__37084){
return (function (p1__37077_SHARP_){
return console.warn(p1__37077_SHARP_);
});
;})(pred__37083,expr__37084))
} else {
if(cljs.core.truth_(pred__37083.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37084))){
return ((function (pred__37083,expr__37084){
return (function (p1__37078_SHARP_){
return console.debug(p1__37078_SHARP_);
});
;})(pred__37083,expr__37084))
} else {
if(cljs.core.truth_(pred__37083.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37084))){
return ((function (pred__37083,expr__37084){
return (function (p1__37079_SHARP_){
return console.error(p1__37079_SHARP_);
});
;})(pred__37083,expr__37084))
} else {
return ((function (pred__37083,expr__37084){
return (function (p1__37080_SHARP_){
return console.log(p1__37080_SHARP_);
});
;})(pred__37083,expr__37084))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37087){
var map__37088 = p__37087;
var map__37088__$1 = ((((!((map__37088 == null)))?((((map__37088.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37088.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__37088):map__37088);
var opts = map__37088__$1;
var eval_fn = cljs.core.get.call(null,map__37088__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37090_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37092,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1515953257874
