...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("meeting.events","set-active-panel","meeting.events/set-active-panel",617377240),(function (db,p__36015){
var vec__36016 = p__36015;
var _ = cljs.core.nth.call(null,vec__36016,(0),null);
var active_panel = cljs.core.nth.call(null,vec__36016,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"active-panel","active-panel",-1802545994),active_panel);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("meeting.events","set-active-meeting-id","meeting.events/set-active-meeting-id",-1157732228),(function (db,p__36019){
var vec__36020 = p__36019;
var _ = cljs.core.nth.call(null,vec__36020,(0),null);
var id = cljs.core.nth.call(null,vec__36020,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"active-meeting-id","active-meeting-id",471672036),id);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("meeting.events","unset-active-meeting-id","meeting.events/unset-active-meeting-id",-278435922),(function (db,p__36023){
var vec__36024 = p__36023;
var _ = cljs.core.nth.call(null,vec__36024,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__36024,(1),null);
return cljs.core.dissoc.call(null,db,new cljs.core.Keyword(null,"active-meeting-id","active-meeting-id",471672036));
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("meeting.events","delete-meeting!","meeting.events/delete-meeting!",2001083377),(function (db,p__36027){
var vec__36028 = p__36027;
var _ = cljs.core.nth.call(null,vec__36028,(0),null);
var id = cljs.core.nth.call(null,vec__36028,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("meeting.events","create-meeting!","meeting.events/create-meeting!",-427757798),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.call(null,new cljs.core.Keyword(null,"meeting-id","meeting-id",1530187103))], null),(function (cofx,p__36031){
var vec__36032 = p__36031;
var _ = cljs.core.nth.call(null,vec__36032,(0),null);
var new_meeting = cljs.core.nth.call(null,vec__36032,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("meeting.events","set-hash!","meeting.events/set-hash!",1048468244),(function (cofx,p__36035){
var vec__36036 = p__36035;
var _ = cljs.core.nth.call(null,vec__36036,(0),null);
var location = cljs.core.nth.call(null,vec__36036,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("meeting.events","update-meeting!","meeting.events/update-meeting!",716738413),(function (db,p__36039){
var vec__36040 = p__36039;
var _ = cljs.core.nth.call(null,vec__36040,(0),null);
var meeting__$1 = cljs.core.nth.call(null,vec__36040,(1),null);
...
//# sourceMappingURL=events.js.map?rel=1514366048576
