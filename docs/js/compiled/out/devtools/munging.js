...
var o39452 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39452["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39453 = temp__4655__auto____$1;
return (o39453["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__38596__auto___39456 = t;
(o__38596__auto___39456["cljs$lang$ctorPrWriter"]).call(o__38596__auto___39456,t,writer);
}catch (e39455){var __39457 = e39455;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39458 = num_code;
switch (G__39458) {
case (1):
return (185);
...
}catch (e39460){var _e__38603__auto__ = e39460;
return false;
}})())){
...
var vec__39461 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39461,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o39464 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39464["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39465 = temp__4655__auto____$1;
return (o39465["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___39472 = arguments.length;
var i__29456__auto___39473 = (0);
while(true){
if((i__29456__auto___39473 < len__29455__auto___39472)){
args__29462__auto__.push((arguments[i__29456__auto___39473]));

var G__39474 = (i__29456__auto___39473 + (1));
i__29456__auto___39473 = G__39474;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39468){
var vec__39469 = p__39468;
var ns_detector = cljs.core.nth.call(null,vec__39469,(0),null);
...
var G__39475 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39476 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39475;
remaining_tokens = G__39476;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39466){
var G__39467 = cljs.core.first.call(null,seq39466);
var seq39466__$1 = cljs.core.next.call(null,seq39466);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39467,seq39466__$1);
});
...
var vec__39480 = cljs.core.split_with.call(null,(function (p1__39479_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39479_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39480,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39480,(1),null);
...
var vec__39483 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39483,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39483,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39486 = cljs.core.rest.call(null,remaining_tokens);
var G__39487 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39486;
name_tokens = G__39487;
continue;
} else {
...
var vec__39490 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39490,(0),null);
var arity = cljs.core.nth.call(null,vec__39490,(1),null);
var vec__39493 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39493,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39493,(1),null);
var vec__39496 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39496,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39496,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39496,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39496,(3),null);
...
var vec__39502 = result;
var munged_ns = cljs.core.nth.call(null,vec__39502,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39502,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39502,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39502,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39502,(4),null);
var arity = cljs.core.nth.call(null,vec__39502,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39506 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39506,(0),null);
var args = cljs.core.nth.call(null,vec__39506,(1),null);
var vec__39509 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39509,(0),null);
var name = cljs.core.nth.call(null,vec__39509,(1),null);
...
var G__39513 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39514){
var vec__39515 = p__39514;
var arity = cljs.core.nth.call(null,vec__39515,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39515,(1),null);
...
return cljs.core.get.call(null,arities,p1__39518_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39519_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___39526 = arguments.length;
var i__29456__auto___39527 = (0);
while(true){
if((i__29456__auto___39527 < len__29455__auto___39526)){
args__29462__auto__.push((arguments[i__29456__auto___39527]));

var G__39528 = (i__29456__auto___39527 + (1));
i__29456__auto___39527 = G__39528;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39522){
var vec__39523 = p__39522;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39523,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39520){
var G__39521 = cljs.core.first.call(null,seq39520);
var seq39520__$1 = cljs.core.next.call(null,seq39520);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39521,seq39520__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39531__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39531__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39531__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39531__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39532 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39532,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39532,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39532,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39532,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39532,(4),null);
var arity = cljs.core.nth.call(null,vec__39532,(5),null);
...
}catch (e39536){var _e__38603__auto__ = e39536;
...
var G__39537 = (obj[cljs.core.first.call(null,path)]);
var G__39538 = cljs.core.rest.call(null,path);
obj = G__39537;
path = G__39538;
continue;
} else {
...
return (function (accum,p__39539){
var vec__39540 = p__39539;
var bit = cljs.core.nth.call(null,vec__39540,(0),null);
var protocol = cljs.core.nth.call(null,vec__39540,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39543){
var vec__39544 = p__39543;
var ns = cljs.core.nth.call(null,vec__39544,(0),null);
var name = cljs.core.nth.call(null,vec__39544,(1),null);
var selector = cljs.core.nth.call(null,vec__39544,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39549,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39549,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39549,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39547_SHARP_){
return (obj[cljs.core.first.call(null,p1__39547_SHARP_)]);
});})(name,sorted_matches,vec__39549,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1513400458706
