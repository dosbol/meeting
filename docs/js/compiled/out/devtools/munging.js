...
var o43318 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43318["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43319 = temp__4655__auto____$1;
return (o43319["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42462__auto__ = f;
return (o__42462__auto__["toString"]).call(o__42462__auto__);
} else {
return "";
}
}catch (e43320){var _ = e43320;
return "";
}});
...
try{var o__42462__auto___43322 = t;
(o__42462__auto___43322["cljs$lang$ctorPrWriter"]).call(o__42462__auto___43322,t,writer);
}catch (e43321){var __43323 = e43321;
}
...
var char_code = (function (){var o__42462__auto__ = (new String(char$));
return (o__42462__auto__["charCodeAt"]).call(o__42462__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42462__auto__ = String;
return (o__42462__auto__["fromCharCode"]).call(o__42462__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43324 = num_code;
switch (G__43324) {
case (1):
return (185);
...
var o__42462__auto__ = String;
return (o__42462__auto__["fromCharCode"]).call(o__42462__auto__,superscript_code);
});
/**
...
}catch (e43326){var _e__42469__auto__ = e43326;
return false;
}})())){
...
var vec__43327 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43327,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o43330 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43330["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43331 = temp__4655__auto____$1;
return (o43331["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28364__auto___43338 = arguments.length;
var i__28365__auto___43339 = (0);
while(true){
if((i__28365__auto___43339 < len__28364__auto___43338)){
args__28371__auto__.push((arguments[i__28365__auto___43339]));

var G__43340 = (i__28365__auto___43339 + (1));
i__28365__auto___43339 = G__43340;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43334){
var vec__43335 = p__43334;
var ns_detector = cljs.core.nth.call(null,vec__43335,(0),null);
...
var G__43341 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43342 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43341;
remaining_tokens = G__43342;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43332){
var G__43333 = cljs.core.first.call(null,seq43332);
var seq43332__$1 = cljs.core.next.call(null,seq43332);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__43333,seq43332__$1);
});
...
var vec__43346 = cljs.core.split_with.call(null,(function (p1__43345_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43345_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43346,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43346,(1),null);
...
var vec__43349 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43349,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43349,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43352 = cljs.core.rest.call(null,remaining_tokens);
var G__43353 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43352;
name_tokens = G__43353;
continue;
} else {
...
var vec__43356 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43356,(0),null);
var arity = cljs.core.nth.call(null,vec__43356,(1),null);
var vec__43359 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43359,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43359,(1),null);
var vec__43362 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43362,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43362,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43362,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43362,(3),null);
...
var vec__43368 = result;
var munged_ns = cljs.core.nth.call(null,vec__43368,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43368,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43368,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43368,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43368,(4),null);
var arity = cljs.core.nth.call(null,vec__43368,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__43372 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__43372,(0),null);
var args = cljs.core.nth.call(null,vec__43372,(1),null);
var vec__43375 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43375,(0),null);
var name = cljs.core.nth.call(null,vec__43375,(1),null);
...
var G__43378 = (arity + (1));
var G__43379 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43380){
var vec__43381 = p__43380;
var arity = cljs.core.nth.call(null,vec__43381,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43381,(1),null);
...
return cljs.core.get.call(null,arities,p1__43384_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43385_SHARP_);
...
var args__28371__auto__ = [];
var len__28364__auto___43392 = arguments.length;
var i__28365__auto___43393 = (0);
while(true){
if((i__28365__auto___43393 < len__28364__auto___43392)){
args__28371__auto__.push((arguments[i__28365__auto___43393]));

var G__43394 = (i__28365__auto___43393 + (1));
i__28365__auto___43393 = G__43394;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43388){
var vec__43389 = p__43388;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43389,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43386){
var G__43387 = cljs.core.first.call(null,seq43386);
var seq43386__$1 = cljs.core.next.call(null,seq43386);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__43387,seq43386__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43397__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43397__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43397__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43397__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43398 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43398,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43398,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43398,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43398,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43398,(4),null);
var arity = cljs.core.nth.call(null,vec__43398,(5),null);
...
var o__42462__auto__ = f;
return (o__42462__auto__["getBasis"]).call(o__42462__auto__);
});
/**
...
}catch (e43402){var _e__42469__auto__ = e43402;
...
var G__43403 = (obj[cljs.core.first.call(null,path)]);
var G__43404 = cljs.core.rest.call(null,path);
obj = G__43403;
path = G__43404;
continue;
} else {
...
return (function (accum,p__43405){
var vec__43406 = p__43405;
var bit = cljs.core.nth.call(null,vec__43406,(0),null);
var protocol = cljs.core.nth.call(null,vec__43406,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43409){
var vec__43410 = p__43409;
var ns = cljs.core.nth.call(null,vec__43410,(0),null);
var name = cljs.core.nth.call(null,vec__43410,(1),null);
var selector = cljs.core.nth.call(null,vec__43410,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__43415,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43415,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43415,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43413_SHARP_){
return (obj[cljs.core.first.call(null,p1__43413_SHARP_)]);
});})(name,sorted_matches,vec__43415,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1517373817639
