...
var o43245 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43245["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43246 = temp__4655__auto____$1;
return (o43246["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42389__auto__ = f;
return (o__42389__auto__["toString"]).call(o__42389__auto__);
} else {
return "";
}
}catch (e43247){var _ = e43247;
return "";
}});
...
try{var o__42389__auto___43249 = t;
(o__42389__auto___43249["cljs$lang$ctorPrWriter"]).call(o__42389__auto___43249,t,writer);
}catch (e43248){var __43250 = e43248;
}
...
var char_code = (function (){var o__42389__auto__ = (new String(char$));
return (o__42389__auto__["charCodeAt"]).call(o__42389__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42389__auto__ = String;
return (o__42389__auto__["fromCharCode"]).call(o__42389__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43251 = num_code;
switch (G__43251) {
case (1):
return (185);
...
var o__42389__auto__ = String;
return (o__42389__auto__["fromCharCode"]).call(o__42389__auto__,superscript_code);
});
/**
...
}catch (e43253){var _e__42396__auto__ = e43253;
return false;
}})())){
...
var vec__43254 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43254,(0),null);
...
var or__27196__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o43257 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43257["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43258 = temp__4655__auto____$1;
return (o43258["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28365__auto___43265 = arguments.length;
var i__28366__auto___43266 = (0);
while(true){
if((i__28366__auto___43266 < len__28365__auto___43265)){
args__28372__auto__.push((arguments[i__28366__auto___43266]));

var G__43267 = (i__28366__auto___43266 + (1));
i__28366__auto___43266 = G__43267;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28373__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43261){
var vec__43262 = p__43261;
var ns_detector = cljs.core.nth.call(null,vec__43262,(0),null);
var effective_detector = (function (){var or__27196__auto__ = ns_detector;
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
...
var G__43268 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43269 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43268;
remaining_tokens = G__43269;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43259){
var G__43260 = cljs.core.first.call(null,seq43259);
var seq43259__$1 = cljs.core.next.call(null,seq43259);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__43260,seq43259__$1);
});
...
var vec__43273 = cljs.core.split_with.call(null,(function (p1__43272_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43272_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43273,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43273,(1),null);
...
var vec__43276 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43276,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43276,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43279 = cljs.core.rest.call(null,remaining_tokens);
var G__43280 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43279;
name_tokens = G__43280;
continue;
} else {
...
var vec__43283 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43283,(0),null);
var arity = cljs.core.nth.call(null,vec__43283,(1),null);
var vec__43286 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43286,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43286,(1),null);
var vec__43289 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43289,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43289,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43289,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43289,(3),null);
...
var vec__43295 = result;
var munged_ns = cljs.core.nth.call(null,vec__43295,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43295,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43295,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43295,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43295,(4),null);
var arity = cljs.core.nth.call(null,vec__43295,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__43299 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__43299,(0),null);
var args = cljs.core.nth.call(null,vec__43299,(1),null);
var vec__43302 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43302,(0),null);
var name = cljs.core.nth.call(null,vec__43302,(1),null);
...
var G__43305 = (arity + (1));
var G__43306 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43307){
var vec__43308 = p__43307;
var arity = cljs.core.nth.call(null,vec__43308,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43308,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__27196__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__43311_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__43312_SHARP_){
return cljs.core.drop.call(null,(2),p1__43312_SHARP_);
...
var args__28372__auto__ = [];
var len__28365__auto___43319 = arguments.length;
var i__28366__auto___43320 = (0);
while(true){
if((i__28366__auto___43320 < len__28365__auto___43319)){
args__28372__auto__.push((arguments[i__28366__auto___43320]));

var G__43321 = (i__28366__auto___43320 + (1));
i__28366__auto___43320 = G__43321;
continue;
} else {
}
break;
...
var argseq__28373__auto__ = ((((1) < args__28372__auto__.length))?(new cljs.core.IndexedSeq(args__28372__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28373__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43315){
var vec__43316 = p__43315;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43316,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43313){
var G__43314 = cljs.core.first.call(null,seq43313);
var seq43313__$1 = cljs.core.next.call(null,seq43313);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__43314,seq43313__$1);
});
...
var G__43322 = arg;
var G__43322__$1 = (((G__43322 instanceof cljs.core.Keyword))?G__43322.fqn:null);
switch (G__43322__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__27196__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__27184__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__27196__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
...
var map__43324 = options;
var map__43324__$1 = ((((!((map__43324 == null)))?((((map__43324.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43324.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43324):map__43324);
var include_ns_QMARK_ = cljs.core.get.call(null,map__43324__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43324__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43324__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43324__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43325 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43325,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43325,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43325,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43325,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43325,(4),null);
var arity = cljs.core.nth.call(null,vec__43325,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__27184__auto__ = protocol_ns;
if(cljs.core.truth_(and__27184__auto__)){
return cljs.core.not.call(null,(function (){var and__27184__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__27196__auto__ = protocol_part;
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
return fn_part;
...
var o__42389__auto__ = f;
return (o__42389__auto__["getBasis"]).call(o__42389__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__27184__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__27184__auto__)){
...
}catch (e43329){var _e__42396__auto__ = e43329;
...
var G__43330 = (obj[cljs.core.first.call(null,path)]);
var G__43331 = cljs.core.rest.call(null,path);
obj = G__43330;
path = G__43331;
continue;
} else {
...
var partition_bits = (function (){var or__27196__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
return (0);
...
return (function (accum,p__43332){
var vec__43333 = p__43332;
var bit = cljs.core.nth.call(null,vec__43333,(0),null);
var protocol = cljs.core.nth.call(null,vec__43333,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43336){
var vec__43337 = p__43336;
var ns = cljs.core.nth.call(null,vec__43337,(0),null);
var name = cljs.core.nth.call(null,vec__43337,(1),null);
var selector = cljs.core.nth.call(null,vec__43337,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__43342,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43342,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43342,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43340_SHARP_){
return (obj[cljs.core.first.call(null,p1__43340_SHARP_)]);
});})(name,sorted_matches,vec__43342,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1514660185158
