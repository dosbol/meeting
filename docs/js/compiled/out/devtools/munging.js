...
var o43315 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43315["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43316 = temp__4655__auto____$1;
return (o43316["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42459__auto__ = f;
return (o__42459__auto__["toString"]).call(o__42459__auto__);
} else {
return "";
}
}catch (e43317){var _ = e43317;
return "";
}});
...
try{var o__42459__auto___43319 = t;
(o__42459__auto___43319["cljs$lang$ctorPrWriter"]).call(o__42459__auto___43319,t,writer);
}catch (e43318){var __43320 = e43318;
}
...
var char_code = (function (){var o__42459__auto__ = (new String(char$));
return (o__42459__auto__["charCodeAt"]).call(o__42459__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42459__auto__ = String;
return (o__42459__auto__["fromCharCode"]).call(o__42459__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43321 = num_code;
switch (G__43321) {
case (1):
return (185);
...
var o__42459__auto__ = String;
return (o__42459__auto__["fromCharCode"]).call(o__42459__auto__,superscript_code);
});
/**
...
}catch (e43323){var _e__42466__auto__ = e43323;
return false;
}})())){
...
var vec__43324 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43324,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o43327 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43327["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43328 = temp__4655__auto____$1;
return (o43328["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43331){
var vec__43332 = p__43331;
var ns_detector = cljs.core.nth.call(null,vec__43332,(0),null);
...
var G__43338 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43339 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43338;
remaining_tokens = G__43339;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43329){
var G__43330 = cljs.core.first.call(null,seq43329);
var seq43329__$1 = cljs.core.next.call(null,seq43329);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__43330,seq43329__$1);
});
...
var vec__43343 = cljs.core.split_with.call(null,(function (p1__43342_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43342_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43343,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43343,(1),null);
...
var vec__43346 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43346,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43346,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43349 = cljs.core.rest.call(null,remaining_tokens);
var G__43350 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43349;
name_tokens = G__43350;
continue;
} else {
...
var vec__43353 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43353,(0),null);
var arity = cljs.core.nth.call(null,vec__43353,(1),null);
var vec__43356 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43356,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43356,(1),null);
var vec__43359 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43359,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43359,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43359,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43359,(3),null);
...
var vec__43365 = result;
var munged_ns = cljs.core.nth.call(null,vec__43365,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43365,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43365,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43365,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43365,(4),null);
var arity = cljs.core.nth.call(null,vec__43365,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__43369 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__43369,(0),null);
var args = cljs.core.nth.call(null,vec__43369,(1),null);
var vec__43372 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43372,(0),null);
var name = cljs.core.nth.call(null,vec__43372,(1),null);
...
var G__43375 = (arity + (1));
var G__43376 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43377){
var vec__43378 = p__43377;
var arity = cljs.core.nth.call(null,vec__43378,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43378,(1),null);
...
return cljs.core.get.call(null,arities,p1__43381_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43382_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43385){
var vec__43386 = p__43385;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43386,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43383){
var G__43384 = cljs.core.first.call(null,seq43383);
var seq43383__$1 = cljs.core.next.call(null,seq43383);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__43384,seq43383__$1);
});
...
var G__43392 = arg;
var G__43392__$1 = (((G__43392 instanceof cljs.core.Keyword))?G__43392.fqn:null);
switch (G__43392__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43394__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43394__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43394__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43394__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43395 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43395,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43395,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43395,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43395,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43395,(4),null);
var arity = cljs.core.nth.call(null,vec__43395,(5),null);
...
var o__42459__auto__ = f;
return (o__42459__auto__["getBasis"]).call(o__42459__auto__);
});
/**
...
}catch (e43399){var _e__42466__auto__ = e43399;
...
var G__43400 = (obj[cljs.core.first.call(null,path)]);
var G__43401 = cljs.core.rest.call(null,path);
obj = G__43400;
path = G__43401;
continue;
} else {
...
return (function (accum,p__43402){
var vec__43403 = p__43402;
var bit = cljs.core.nth.call(null,vec__43403,(0),null);
var protocol = cljs.core.nth.call(null,vec__43403,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43406){
var vec__43407 = p__43406;
var ns = cljs.core.nth.call(null,vec__43407,(0),null);
var name = cljs.core.nth.call(null,vec__43407,(1),null);
var selector = cljs.core.nth.call(null,vec__43407,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__43412,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43412,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43412,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43410_SHARP_){
return (obj[cljs.core.first.call(null,p1__43410_SHARP_)]);
});})(name,sorted_matches,vec__43412,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1516053525011
