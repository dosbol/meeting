...
var o43260 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43260["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43261 = temp__4655__auto____$1;
return (o43261["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42404__auto__ = f;
return (o__42404__auto__["toString"]).call(o__42404__auto__);
} else {
return "";
}
}catch (e43262){var _ = e43262;
return "";
}});
...
try{var o__42404__auto___43264 = t;
(o__42404__auto___43264["cljs$lang$ctorPrWriter"]).call(o__42404__auto___43264,t,writer);
}catch (e43263){var __43265 = e43263;
}
...
var char_code = (function (){var o__42404__auto__ = (new String(char$));
return (o__42404__auto__["charCodeAt"]).call(o__42404__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42404__auto__ = String;
return (o__42404__auto__["fromCharCode"]).call(o__42404__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43266 = num_code;
switch (G__43266) {
case (1):
return (185);
...
var o__42404__auto__ = String;
return (o__42404__auto__["fromCharCode"]).call(o__42404__auto__,superscript_code);
});
/**
...
}catch (e43268){var _e__42411__auto__ = e43268;
return false;
}})())){
...
var vec__43269 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43269,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o43272 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43272["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43273 = temp__4655__auto____$1;
return (o43273["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28364__auto___43280 = arguments.length;
var i__28365__auto___43281 = (0);
while(true){
if((i__28365__auto___43281 < len__28364__auto___43280)){
args__28371__auto__.push((arguments[i__28365__auto___43281]));

var G__43282 = (i__28365__auto___43281 + (1));
i__28365__auto___43281 = G__43282;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43276){
var vec__43277 = p__43276;
var ns_detector = cljs.core.nth.call(null,vec__43277,(0),null);
...
var G__43283 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43284 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43283;
remaining_tokens = G__43284;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43274){
var G__43275 = cljs.core.first.call(null,seq43274);
var seq43274__$1 = cljs.core.next.call(null,seq43274);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__43275,seq43274__$1);
});
...
var vec__43288 = cljs.core.split_with.call(null,(function (p1__43287_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43287_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43288,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43288,(1),null);
...
var vec__43291 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43291,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43291,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43294 = cljs.core.rest.call(null,remaining_tokens);
var G__43295 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43294;
name_tokens = G__43295;
continue;
} else {
...
var vec__43298 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43298,(0),null);
var arity = cljs.core.nth.call(null,vec__43298,(1),null);
var vec__43301 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43301,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43301,(1),null);
var vec__43304 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43304,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43304,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43304,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43304,(3),null);
...
var vec__43310 = result;
var munged_ns = cljs.core.nth.call(null,vec__43310,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43310,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43310,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43310,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43310,(4),null);
var arity = cljs.core.nth.call(null,vec__43310,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__43314 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__43314,(0),null);
var args = cljs.core.nth.call(null,vec__43314,(1),null);
var vec__43317 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43317,(0),null);
var name = cljs.core.nth.call(null,vec__43317,(1),null);
...
var G__43320 = (arity + (1));
var G__43321 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43322){
var vec__43323 = p__43322;
var arity = cljs.core.nth.call(null,vec__43323,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43323,(1),null);
...
return cljs.core.get.call(null,arities,p1__43326_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43327_SHARP_);
...
var args__28371__auto__ = [];
var len__28364__auto___43334 = arguments.length;
var i__28365__auto___43335 = (0);
while(true){
if((i__28365__auto___43335 < len__28364__auto___43334)){
args__28371__auto__.push((arguments[i__28365__auto___43335]));

var G__43336 = (i__28365__auto___43335 + (1));
i__28365__auto___43335 = G__43336;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43330){
var vec__43331 = p__43330;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43331,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43328){
var G__43329 = cljs.core.first.call(null,seq43328);
var seq43328__$1 = cljs.core.next.call(null,seq43328);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__43329,seq43328__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43339__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43339__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43339__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43339__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43340 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43340,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43340,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43340,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43340,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43340,(4),null);
var arity = cljs.core.nth.call(null,vec__43340,(5),null);
...
var o__42404__auto__ = f;
return (o__42404__auto__["getBasis"]).call(o__42404__auto__);
});
/**
...
}catch (e43344){var _e__42411__auto__ = e43344;
...
var G__43345 = (obj[cljs.core.first.call(null,path)]);
var G__43346 = cljs.core.rest.call(null,path);
obj = G__43345;
path = G__43346;
continue;
} else {
...
return (function (accum,p__43347){
var vec__43348 = p__43347;
var bit = cljs.core.nth.call(null,vec__43348,(0),null);
var protocol = cljs.core.nth.call(null,vec__43348,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43351){
var vec__43352 = p__43351;
var ns = cljs.core.nth.call(null,vec__43352,(0),null);
var name = cljs.core.nth.call(null,vec__43352,(1),null);
var selector = cljs.core.nth.call(null,vec__43352,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__43357,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43357,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43357,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43355_SHARP_){
return (obj[cljs.core.first.call(null,p1__43355_SHARP_)]);
});})(name,sorted_matches,vec__43357,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1515953294216
