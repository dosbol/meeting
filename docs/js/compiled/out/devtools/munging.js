...
var o41766 = temp__4655__auto__;
var temp__4655__auto____$1 = (o41766["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o41767 = temp__4655__auto____$1;
return (o41767["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40910__auto__ = f;
return (o__40910__auto__["toString"]).call(o__40910__auto__);
} else {
return "";
}
}catch (e41768){var _ = e41768;
return "";
}});
...
try{var o__40910__auto___41770 = t;
(o__40910__auto___41770["cljs$lang$ctorPrWriter"]).call(o__40910__auto___41770,t,writer);
}catch (e41769){var __41771 = e41769;
}
...
var char_code = (function (){var o__40910__auto__ = (new String(char$));
return (o__40910__auto__["charCodeAt"]).call(o__40910__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40910__auto__ = String;
return (o__40910__auto__["fromCharCode"]).call(o__40910__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41772 = num_code;
switch (G__41772) {
case (1):
return (185);
...
var o__40910__auto__ = String;
return (o__40910__auto__["fromCharCode"]).call(o__40910__auto__,superscript_code);
});
/**
...
}catch (e41774){var _e__40917__auto__ = e41774;
return false;
}})())){
...
var vec__41775 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__41775,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o41778 = temp__4655__auto__;
var temp__4655__auto____$1 = (o41778["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o41779 = temp__4655__auto____$1;
return (o41779["nameToPath"]);
} else {
return null;
}
} else {
...
args__28371__auto__.push((arguments[i__28365__auto___41787]));
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41782){
var vec__41783 = p__41782;
var ns_detector = cljs.core.nth.call(null,vec__41783,(0),null);
...
var G__41789 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__41790 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__41789;
remaining_tokens = G__41790;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41780){
var G__41781 = cljs.core.first.call(null,seq41780);
var seq41780__$1 = cljs.core.next.call(null,seq41780);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__41781,seq41780__$1);
});
...
var vec__41794 = cljs.core.split_with.call(null,(function (p1__41793_SHARP_){
return cljs.core.not_EQ_.call(null,p1__41793_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__41794,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__41794,(1),null);
...
var vec__41797 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__41797,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__41797,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__41800 = cljs.core.rest.call(null,remaining_tokens);
var G__41801 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__41800;
...
var vec__41804 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__41804,(0),null);
var arity = cljs.core.nth.call(null,vec__41804,(1),null);
var vec__41807 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__41807,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__41807,(1),null);
var vec__41810 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__41810,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__41810,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__41810,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__41810,(3),null);
...
var vec__41816 = result;
var munged_ns = cljs.core.nth.call(null,vec__41816,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__41816,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__41816,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__41816,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__41816,(4),null);
var arity = cljs.core.nth.call(null,vec__41816,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__41820 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__41820,(0),null);
var args = cljs.core.nth.call(null,vec__41820,(1),null);
var vec__41823 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__41823,(0),null);
var name = cljs.core.nth.call(null,vec__41823,(1),null);
...
var G__41826 = (arity + (1));
var G__41827 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41828){
var vec__41829 = p__41828;
var arity = cljs.core.nth.call(null,vec__41829,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__41829,(1),null);
...
return cljs.core.get.call(null,arities,p1__41832_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__41833_SHARP_);
...
var args__28371__auto__ = [];
var len__28364__auto___41840 = arguments.length;
var i__28365__auto___41841 = (0);
while(true){
if((i__28365__auto___41841 < len__28364__auto___41840)){
args__28371__auto__.push((arguments[i__28365__auto___41841]));

var G__41842 = (i__28365__auto___41841 + (1));
i__28365__auto___41841 = G__41842;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41836){
var vec__41837 = p__41836;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__41837,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41834){
var G__41835 = cljs.core.first.call(null,seq41834);
var seq41834__$1 = cljs.core.next.call(null,seq41834);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__41835,seq41834__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__41845__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__41845__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__41845__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__41845__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41846 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__41846,(0),null);
var fn_name = cljs.core.nth.call(null,vec__41846,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__41846,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__41846,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__41846,(4),null);
var arity = cljs.core.nth.call(null,vec__41846,(5),null);
...
var o__40910__auto__ = f;
return (o__40910__auto__["getBasis"]).call(o__40910__auto__);
});
/**
...
}catch (e41850){var _e__40917__auto__ = e41850;
...
var G__41851 = (obj[cljs.core.first.call(null,path)]);
var G__41852 = cljs.core.rest.call(null,path);
obj = G__41851;
path = G__41852;
continue;
} else {
...
return (function (accum,p__41853){
var vec__41854 = p__41853;
var bit = cljs.core.nth.call(null,vec__41854,(0),null);
var protocol = cljs.core.nth.call(null,vec__41854,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41857){
var vec__41858 = p__41857;
var ns = cljs.core.nth.call(null,vec__41858,(0),null);
var name = cljs.core.nth.call(null,vec__41858,(1),null);
var selector = cljs.core.nth.call(null,vec__41858,(2),null);
...
return (function (p__41862){
var vec__41863 = p__41862;
var munged_name = cljs.core.nth.call(null,vec__41863,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__41863,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__41863,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__41861_SHARP_){
return (obj[cljs.core.first.call(null,p1__41861_SHARP_)]);
});})(name,sorted_matches,vec__41863,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1514289227133
