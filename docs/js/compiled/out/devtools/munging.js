...
var o43263 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43263["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43264 = temp__4655__auto____$1;
return (o43264["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42407__auto__ = f;
return (o__42407__auto__["toString"]).call(o__42407__auto__);
} else {
return "";
}
}catch (e43265){var _ = e43265;
return "";
}});
...
try{var o__42407__auto___43267 = t;
(o__42407__auto___43267["cljs$lang$ctorPrWriter"]).call(o__42407__auto___43267,t,writer);
}catch (e43266){var __43268 = e43266;
}
...
var char_code = (function (){var o__42407__auto__ = (new String(char$));
return (o__42407__auto__["charCodeAt"]).call(o__42407__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42407__auto__ = String;
return (o__42407__auto__["fromCharCode"]).call(o__42407__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43269 = num_code;
switch (G__43269) {
case (1):
return (185);
...
var o__42407__auto__ = String;
return (o__42407__auto__["fromCharCode"]).call(o__42407__auto__,superscript_code);
});
/**
...
}catch (e43271){var _e__42414__auto__ = e43271;
return false;
}})())){
...
var vec__43272 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43272,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o43275 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43275["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43276 = temp__4655__auto____$1;
return (o43276["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43279){
var vec__43280 = p__43279;
var ns_detector = cljs.core.nth.call(null,vec__43280,(0),null);
...
var G__43286 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43287 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43286;
remaining_tokens = G__43287;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43277){
var G__43278 = cljs.core.first.call(null,seq43277);
var seq43277__$1 = cljs.core.next.call(null,seq43277);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__43278,seq43277__$1);
});
...
var vec__43291 = cljs.core.split_with.call(null,(function (p1__43290_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43290_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43291,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43291,(1),null);
...
var vec__43294 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43294,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43294,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43297 = cljs.core.rest.call(null,remaining_tokens);
var G__43298 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43297;
name_tokens = G__43298;
continue;
} else {
...
var vec__43301 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43301,(0),null);
var arity = cljs.core.nth.call(null,vec__43301,(1),null);
var vec__43304 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43304,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43304,(1),null);
var vec__43307 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43307,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43307,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43307,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43307,(3),null);
...
var vec__43313 = result;
var munged_ns = cljs.core.nth.call(null,vec__43313,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43313,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43313,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43313,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43313,(4),null);
var arity = cljs.core.nth.call(null,vec__43313,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__43317 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__43317,(0),null);
var args = cljs.core.nth.call(null,vec__43317,(1),null);
var vec__43320 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43320,(0),null);
var name = cljs.core.nth.call(null,vec__43320,(1),null);
...
var G__43323 = (arity + (1));
var G__43324 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43325){
var vec__43326 = p__43325;
var arity = cljs.core.nth.call(null,vec__43326,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43326,(1),null);
...
return cljs.core.get.call(null,arities,p1__43329_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__43330_SHARP_){
return cljs.core.drop.call(null,(2),p1__43330_SHARP_);
...
var args__28371__auto__ = [];
var len__28364__auto___43337 = arguments.length;
var i__28365__auto___43338 = (0);
while(true){
if((i__28365__auto___43338 < len__28364__auto___43337)){
args__28371__auto__.push((arguments[i__28365__auto___43338]));

var G__43339 = (i__28365__auto___43338 + (1));
i__28365__auto___43338 = G__43339;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43333){
var vec__43334 = p__43333;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43334,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43331){
var G__43332 = cljs.core.first.call(null,seq43331);
var seq43331__$1 = cljs.core.next.call(null,seq43331);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__43332,seq43331__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43342__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43342__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43342__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43342__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43343 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43343,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43343,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43343,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43343,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43343,(4),null);
var arity = cljs.core.nth.call(null,vec__43343,(5),null);
...
var o__42407__auto__ = f;
return (o__42407__auto__["getBasis"]).call(o__42407__auto__);
});
/**
...
}catch (e43347){var _e__42414__auto__ = e43347;
...
var G__43348 = (obj[cljs.core.first.call(null,path)]);
var G__43349 = cljs.core.rest.call(null,path);
obj = G__43348;
path = G__43349;
continue;
} else {
...
return (function (accum,p__43350){
var vec__43351 = p__43350;
var bit = cljs.core.nth.call(null,vec__43351,(0),null);
var protocol = cljs.core.nth.call(null,vec__43351,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43354){
var vec__43355 = p__43354;
var ns = cljs.core.nth.call(null,vec__43355,(0),null);
var name = cljs.core.nth.call(null,vec__43355,(1),null);
var selector = cljs.core.nth.call(null,vec__43355,(2),null);
...
return (function (p__43359){
var vec__43360 = p__43359;
var munged_name = cljs.core.nth.call(null,vec__43360,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43360,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43360,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43358_SHARP_){
return (obj[cljs.core.first.call(null,p1__43358_SHARP_)]);
});})(name,sorted_matches,vec__43360,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1515855045945
