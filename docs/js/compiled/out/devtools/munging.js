...
var temp__4655__auto____$1 = (o41765["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o41766 = temp__4655__auto____$1;
return (o41766["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40909__auto__ = f;
return (o__40909__auto__["toString"]).call(o__40909__auto__);
} else {
return "";
}
...
try{var o__40909__auto___41769 = t;
(o__40909__auto___41769["cljs$lang$ctorPrWriter"]).call(o__40909__auto___41769,t,writer);
}catch (e41768){var __41770 = e41768;
}
...
var char_code = (function (){var o__40909__auto__ = (new String(char$));
return (o__40909__auto__["charCodeAt"]).call(o__40909__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40909__auto__ = String;
return (o__40909__auto__["fromCharCode"]).call(o__40909__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41771 = num_code;
switch (G__41771) {
case (1):
return (185);
...
var o__40909__auto__ = String;
return (o__40909__auto__["fromCharCode"]).call(o__40909__auto__,superscript_code);
});
/**
...
}catch (e41773){var _e__40916__auto__ = e41773;
return false;
}})())){
...
var vec__41774 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__41774,(0),null);
...
var temp__4655__auto____$1 = (o41777["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o41778 = temp__4655__auto____$1;
return (o41778["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28364__auto___41785 = arguments.length;
var i__28365__auto___41786 = (0);
while(true){
if((i__28365__auto___41786 < len__28364__auto___41785)){
args__28371__auto__.push((arguments[i__28365__auto___41786]));

var G__41787 = (i__28365__auto___41786 + (1));
i__28365__auto___41786 = G__41787;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41781){
var vec__41782 = p__41781;
var ns_detector = cljs.core.nth.call(null,vec__41782,(0),null);
...
var G__41788 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__41789 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__41788;
remaining_tokens = G__41789;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41779){
var G__41780 = cljs.core.first.call(null,seq41779);
var seq41779__$1 = cljs.core.next.call(null,seq41779);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__41780,seq41779__$1);
});
...
var vec__41793 = cljs.core.split_with.call(null,(function (p1__41792_SHARP_){
return cljs.core.not_EQ_.call(null,p1__41792_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__41793,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__41793,(1),null);
...
var vec__41796 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__41796,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__41796,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__41799 = cljs.core.rest.call(null,remaining_tokens);
var G__41800 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__41799;
name_tokens = G__41800;
continue;
} else {
...
var vec__41803 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__41803,(0),null);
var arity = cljs.core.nth.call(null,vec__41803,(1),null);
var vec__41806 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__41806,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__41806,(1),null);
var vec__41809 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__41809,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__41809,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__41809,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__41809,(3),null);
...
var vec__41815 = result;
var munged_ns = cljs.core.nth.call(null,vec__41815,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__41815,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__41815,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__41815,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__41815,(4),null);
var arity = cljs.core.nth.call(null,vec__41815,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__41819 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__41819,(0),null);
var args = cljs.core.nth.call(null,vec__41819,(1),null);
var vec__41822 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__41822,(0),null);
var name = cljs.core.nth.call(null,vec__41822,(1),null);
...
var G__41825 = (arity + (1));
var G__41826 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41827){
var vec__41828 = p__41827;
var arity = cljs.core.nth.call(null,vec__41828,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__41828,(1),null);
...
return cljs.core.get.call(null,arities,p1__41831_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__41832_SHARP_);
...
args__28371__auto__.push((arguments[i__28365__auto___41840]));
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41835){
var vec__41836 = p__41835;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__41836,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41833){
var G__41834 = cljs.core.first.call(null,seq41833);
var seq41833__$1 = cljs.core.next.call(null,seq41833);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__41834,seq41833__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__41844__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__41844__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__41844__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__41844__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41845 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__41845,(0),null);
var fn_name = cljs.core.nth.call(null,vec__41845,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__41845,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__41845,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__41845,(4),null);
var arity = cljs.core.nth.call(null,vec__41845,(5),null);
...
var o__40909__auto__ = f;
return (o__40909__auto__["getBasis"]).call(o__40909__auto__);
});
/**
...
}catch (e41849){var _e__40916__auto__ = e41849;
...
var G__41850 = (obj[cljs.core.first.call(null,path)]);
var G__41851 = cljs.core.rest.call(null,path);
obj = G__41850;
path = G__41851;
continue;
} else {
...
return (function (accum,p__41852){
var vec__41853 = p__41852;
var bit = cljs.core.nth.call(null,vec__41853,(0),null);
var protocol = cljs.core.nth.call(null,vec__41853,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41856){
var vec__41857 = p__41856;
var ns = cljs.core.nth.call(null,vec__41857,(0),null);
var name = cljs.core.nth.call(null,vec__41857,(1),null);
var selector = cljs.core.nth.call(null,vec__41857,(2),null);
...
return (function (p__41861){
var vec__41862 = p__41861;
var munged_name = cljs.core.nth.call(null,vec__41862,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__41862,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__41862,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__41860_SHARP_){
return (obj[cljs.core.first.call(null,p1__41860_SHARP_)]);
});})(name,sorted_matches,vec__41862,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1514366073567
