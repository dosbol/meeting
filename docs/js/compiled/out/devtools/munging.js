...
var o39466 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39466["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39467 = temp__4655__auto____$1;
return (o39467["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38610__auto__ = f;
return (o__38610__auto__["toString"]).call(o__38610__auto__);
} else {
return "";
}
}catch (e39468){var _ = e39468;
return "";
}});
...
try{var o__38610__auto___39470 = t;
(o__38610__auto___39470["cljs$lang$ctorPrWriter"]).call(o__38610__auto___39470,t,writer);
}catch (e39469){var __39471 = e39469;
}
...
var char_code = (function (){var o__38610__auto__ = (new String(char$));
return (o__38610__auto__["charCodeAt"]).call(o__38610__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38610__auto__ = String;
return (o__38610__auto__["fromCharCode"]).call(o__38610__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39472 = num_code;
switch (G__39472) {
case (1):
return (185);
...
var o__38610__auto__ = String;
return (o__38610__auto__["fromCharCode"]).call(o__38610__auto__,superscript_code);
});
/**
...
}catch (e39474){var _e__38617__auto__ = e39474;
return false;
}})())){
...
var vec__39475 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39475,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o39478 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39478["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39479 = temp__4655__auto____$1;
return (o39479["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___39486 = arguments.length;
var i__29456__auto___39487 = (0);
while(true){
if((i__29456__auto___39487 < len__29455__auto___39486)){
args__29462__auto__.push((arguments[i__29456__auto___39487]));

var G__39488 = (i__29456__auto___39487 + (1));
i__29456__auto___39487 = G__39488;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39482){
var vec__39483 = p__39482;
var ns_detector = cljs.core.nth.call(null,vec__39483,(0),null);
...
var G__39489 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39490 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39489;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39480){
var G__39481 = cljs.core.first.call(null,seq39480);
var seq39480__$1 = cljs.core.next.call(null,seq39480);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39481,seq39480__$1);
});
...
var vec__39494 = cljs.core.split_with.call(null,(function (p1__39493_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39493_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39494,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39494,(1),null);
...
var vec__39497 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39497,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39497,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39500 = cljs.core.rest.call(null,remaining_tokens);
var G__39501 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39500;
...
var vec__39504 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39504,(0),null);
var arity = cljs.core.nth.call(null,vec__39504,(1),null);
var vec__39507 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39507,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39507,(1),null);
var vec__39510 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39510,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39510,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39510,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39510,(3),null);
...
var vec__39516 = result;
var munged_ns = cljs.core.nth.call(null,vec__39516,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39516,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39516,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39516,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39516,(4),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39520 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39520,(0),null);
var args = cljs.core.nth.call(null,vec__39520,(1),null);
var vec__39523 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39523,(0),null);
var name = cljs.core.nth.call(null,vec__39523,(1),null);
...
var G__39526 = (arity + (1));
var G__39527 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39528){
var vec__39529 = p__39528;
var arity = cljs.core.nth.call(null,vec__39529,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39529,(1),null);
...
return cljs.core.get.call(null,arities,p1__39532_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39533_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___39540 = arguments.length;
var i__29456__auto___39541 = (0);
while(true){
if((i__29456__auto___39541 < len__29455__auto___39540)){
args__29462__auto__.push((arguments[i__29456__auto___39541]));

var G__39542 = (i__29456__auto___39541 + (1));
i__29456__auto___39541 = G__39542;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39536){
var vec__39537 = p__39536;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39537,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39534){
var G__39535 = cljs.core.first.call(null,seq39534);
var seq39534__$1 = cljs.core.next.call(null,seq39534);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39535,seq39534__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39545__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39545__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39545__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39545__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39546 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39546,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39546,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39546,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39546,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39546,(4),null);
var arity = cljs.core.nth.call(null,vec__39546,(5),null);
...
var o__38610__auto__ = f;
return (o__38610__auto__["getBasis"]).call(o__38610__auto__);
});
/**
...
}catch (e39550){var _e__38617__auto__ = e39550;
...
var G__39551 = (obj[cljs.core.first.call(null,path)]);
var G__39552 = cljs.core.rest.call(null,path);
obj = G__39551;
path = G__39552;
continue;
} else {
...
return (function (accum,p__39553){
var vec__39554 = p__39553;
var bit = cljs.core.nth.call(null,vec__39554,(0),null);
var protocol = cljs.core.nth.call(null,vec__39554,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39557){
var vec__39558 = p__39557;
var ns = cljs.core.nth.call(null,vec__39558,(0),null);
var name = cljs.core.nth.call(null,vec__39558,(1),null);
var selector = cljs.core.nth.call(null,vec__39558,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39563,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39563,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39563,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39561_SHARP_){
return (obj[cljs.core.first.call(null,p1__39561_SHARP_)]);
});})(name,sorted_matches,vec__39563,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1513768325468
