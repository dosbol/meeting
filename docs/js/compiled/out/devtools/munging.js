...
var o39432 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39432["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39433 = temp__4655__auto____$1;
return (o39433["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38576__auto__ = f;
return (o__38576__auto__["toString"]).call(o__38576__auto__);
} else {
return "";
}
...
try{var o__38576__auto___39436 = t;
(o__38576__auto___39436["cljs$lang$ctorPrWriter"]).call(o__38576__auto___39436,t,writer);
}catch (e39435){var __39437 = e39435;
}
...
var char_code = (function (){var o__38576__auto__ = (new String(char$));
return (o__38576__auto__["charCodeAt"]).call(o__38576__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38576__auto__ = String;
return (o__38576__auto__["fromCharCode"]).call(o__38576__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39438 = num_code;
switch (G__39438) {
case (1):
return (185);
...
var o__38576__auto__ = String;
return (o__38576__auto__["fromCharCode"]).call(o__38576__auto__,superscript_code);
});
/**
...
}catch (e39440){var _e__38583__auto__ = e39440;
return false;
}})())){
...
var vec__39441 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39441,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o39444 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39444["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39445 = temp__4655__auto____$1;
return (o39445["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___39452 = arguments.length;
var i__29456__auto___39453 = (0);
while(true){
if((i__29456__auto___39453 < len__29455__auto___39452)){
args__29462__auto__.push((arguments[i__29456__auto___39453]));

var G__39454 = (i__29456__auto___39453 + (1));
i__29456__auto___39453 = G__39454;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39448){
var vec__39449 = p__39448;
var ns_detector = cljs.core.nth.call(null,vec__39449,(0),null);
...
var G__39455 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39456 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39455;
remaining_tokens = G__39456;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39446){
var G__39447 = cljs.core.first.call(null,seq39446);
var seq39446__$1 = cljs.core.next.call(null,seq39446);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39447,seq39446__$1);
});
...
var vec__39460 = cljs.core.split_with.call(null,(function (p1__39459_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39459_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39460,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39460,(1),null);
...
var vec__39463 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39463,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39463,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39466 = cljs.core.rest.call(null,remaining_tokens);
var G__39467 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39466;
name_tokens = G__39467;
continue;
} else {
...
var vec__39470 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39470,(0),null);
var arity = cljs.core.nth.call(null,vec__39470,(1),null);
var vec__39473 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39473,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39473,(1),null);
var vec__39476 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39476,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39476,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39476,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39476,(3),null);
...
var vec__39482 = result;
var munged_ns = cljs.core.nth.call(null,vec__39482,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39482,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39482,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39482,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39482,(4),null);
var arity = cljs.core.nth.call(null,vec__39482,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39486 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39486,(0),null);
var args = cljs.core.nth.call(null,vec__39486,(1),null);
var vec__39489 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39489,(0),null);
var name = cljs.core.nth.call(null,vec__39489,(1),null);
...
var G__39492 = (arity + (1));
var G__39493 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39494){
var vec__39495 = p__39494;
var arity = cljs.core.nth.call(null,vec__39495,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39495,(1),null);
...
return (function (p1__39498_SHARP_){
return cljs.core.get.call(null,arities,p1__39498_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39499_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___39506 = arguments.length;
var i__29456__auto___39507 = (0);
while(true){
if((i__29456__auto___39507 < len__29455__auto___39506)){
args__29462__auto__.push((arguments[i__29456__auto___39507]));

var G__39508 = (i__29456__auto___39507 + (1));
i__29456__auto___39507 = G__39508;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39502){
var vec__39503 = p__39502;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39503,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39500){
var G__39501 = cljs.core.first.call(null,seq39500);
var seq39500__$1 = cljs.core.next.call(null,seq39500);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39501,seq39500__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39511__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39511__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39511__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39511__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39512 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39512,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39512,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39512,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39512,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39512,(4),null);
...
var o__38576__auto__ = f;
return (o__38576__auto__["getBasis"]).call(o__38576__auto__);
});
/**
...
}catch (e39516){var _e__38583__auto__ = e39516;
...
var G__39517 = (obj[cljs.core.first.call(null,path)]);
var G__39518 = cljs.core.rest.call(null,path);
obj = G__39517;
path = G__39518;
continue;
} else {
...
return (function (accum,p__39519){
var vec__39520 = p__39519;
var bit = cljs.core.nth.call(null,vec__39520,(0),null);
var protocol = cljs.core.nth.call(null,vec__39520,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39523){
var vec__39524 = p__39523;
var ns = cljs.core.nth.call(null,vec__39524,(0),null);
var name = cljs.core.nth.call(null,vec__39524,(1),null);
var selector = cljs.core.nth.call(null,vec__39524,(2),null);
...
return (function (p__39528){
var vec__39529 = p__39528;
var munged_name = cljs.core.nth.call(null,vec__39529,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39529,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39529,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39527_SHARP_){
return (obj[cljs.core.first.call(null,p1__39527_SHARP_)]);
});})(name,sorted_matches,vec__39529,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1513190790793
