...
var o43322 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43322["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43323 = temp__4655__auto____$1;
return (o43323["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42466__auto__ = f;
return (o__42466__auto__["toString"]).call(o__42466__auto__);
} else {
return "";
}
...
try{var o__42466__auto___43326 = t;
(o__42466__auto___43326["cljs$lang$ctorPrWriter"]).call(o__42466__auto___43326,t,writer);
}catch (e43325){var __43327 = e43325;
}
...
var char_code = (function (){var o__42466__auto__ = (new String(char$));
return (o__42466__auto__["charCodeAt"]).call(o__42466__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42466__auto__ = String;
return (o__42466__auto__["fromCharCode"]).call(o__42466__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43328 = num_code;
switch (G__43328) {
case (1):
return (185);
...
var o__42466__auto__ = String;
return (o__42466__auto__["fromCharCode"]).call(o__42466__auto__,superscript_code);
});
/**
...
}catch (e43330){var _e__42473__auto__ = e43330;
return false;
}})())){
...
var vec__43331 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43331,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o43334 = temp__4655__auto__;
var temp__4655__auto____$1 = (o43334["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o43335 = temp__4655__auto____$1;
return (o43335["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28364__auto___43342 = arguments.length;
var i__28365__auto___43343 = (0);
while(true){
if((i__28365__auto___43343 < len__28364__auto___43342)){
args__28371__auto__.push((arguments[i__28365__auto___43343]));

var G__43344 = (i__28365__auto___43343 + (1));
i__28365__auto___43343 = G__43344;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43338){
var vec__43339 = p__43338;
var ns_detector = cljs.core.nth.call(null,vec__43339,(0),null);
...
var G__43345 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43346 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43345;
remaining_tokens = G__43346;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43336){
var G__43337 = cljs.core.first.call(null,seq43336);
var seq43336__$1 = cljs.core.next.call(null,seq43336);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__43337,seq43336__$1);
});
...
var vec__43350 = cljs.core.split_with.call(null,(function (p1__43349_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43349_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43350,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43350,(1),null);
...
var vec__43353 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43353,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43353,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43356 = cljs.core.rest.call(null,remaining_tokens);
var G__43357 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43356;
name_tokens = G__43357;
continue;
} else {
...
var vec__43360 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43360,(0),null);
var arity = cljs.core.nth.call(null,vec__43360,(1),null);
var vec__43363 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43363,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43363,(1),null);
var vec__43366 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43366,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43366,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43366,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43366,(3),null);
...
var vec__43372 = result;
var munged_ns = cljs.core.nth.call(null,vec__43372,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43372,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43372,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43372,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43372,(4),null);
var arity = cljs.core.nth.call(null,vec__43372,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__43376 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__43376,(0),null);
var args = cljs.core.nth.call(null,vec__43376,(1),null);
var vec__43379 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43379,(0),null);
var name = cljs.core.nth.call(null,vec__43379,(1),null);
...
var G__43382 = (arity + (1));
var G__43383 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43384){
var vec__43385 = p__43384;
var arity = cljs.core.nth.call(null,vec__43385,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43385,(1),null);
...
return cljs.core.get.call(null,arities,p1__43388_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43389_SHARP_);
...
var args__28371__auto__ = [];
var len__28364__auto___43396 = arguments.length;
var i__28365__auto___43397 = (0);
while(true){
if((i__28365__auto___43397 < len__28364__auto___43396)){
args__28371__auto__.push((arguments[i__28365__auto___43397]));

var G__43398 = (i__28365__auto___43397 + (1));
i__28365__auto___43397 = G__43398;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43392){
var vec__43393 = p__43392;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43393,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43390){
var G__43391 = cljs.core.first.call(null,seq43390);
var seq43390__$1 = cljs.core.next.call(null,seq43390);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__43391,seq43390__$1);
});
...
var map__43401 = options;
var map__43401__$1 = ((((!((map__43401 == null)))?((((map__43401.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43401.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43401):map__43401);
var include_ns_QMARK_ = cljs.core.get.call(null,map__43401__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43401__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43401__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43401__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43402 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43402,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43402,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43402,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43402,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43402,(4),null);
var arity = cljs.core.nth.call(null,vec__43402,(5),null);
...
var o__42466__auto__ = f;
return (o__42466__auto__["getBasis"]).call(o__42466__auto__);
});
/**
...
}catch (e43406){var _e__42473__auto__ = e43406;
...
var G__43407 = (obj[cljs.core.first.call(null,path)]);
var G__43408 = cljs.core.rest.call(null,path);
obj = G__43407;
path = G__43408;
continue;
} else {
...
return (function (accum,p__43409){
var vec__43410 = p__43409;
var bit = cljs.core.nth.call(null,vec__43410,(0),null);
var protocol = cljs.core.nth.call(null,vec__43410,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43413){
var vec__43414 = p__43413;
var ns = cljs.core.nth.call(null,vec__43414,(0),null);
var name = cljs.core.nth.call(null,vec__43414,(1),null);
var selector = cljs.core.nth.call(null,vec__43414,(2),null);
...
return (function (p__43418){
var vec__43419 = p__43418;
var munged_name = cljs.core.nth.call(null,vec__43419,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43419,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43419,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43417_SHARP_){
return (obj[cljs.core.first.call(null,p1__43417_SHARP_)]);
});})(name,sorted_matches,vec__43419,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1516093625701
