...
var G__41868 = devtools.prefs.pref.call(null,v);
v = G__41868;
continue;
} else {
return v;
...
}catch (e41871){var _e__40917__auto__ = e41871;
return false;
}})();
...
}catch (e41875){var _e__40917__auto__ = e41875;
return false;
}})();
...
}catch (e41877){var _e__40917__auto__ = e41877;
return false;
}}
}
});
...
var vec__41879 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__41879,(0),null);
var name = cljs.core.nth.call(null,vec__41879,(1),null);
...
return cljs.core.some.call(null,(function (p1__41882_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41882_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1514289227411
