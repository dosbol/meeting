...
var G__39554 = devtools.prefs.pref.call(null,v);
v = G__39554;
continue;
} else {
return v;
...
}catch (e39557){var _e__38603__auto__ = e39557;
return false;
}})();
...
}catch (e39561){var _e__38603__auto__ = e39561;
return false;
}})();
...
}catch (e39563){var _e__38603__auto__ = e39563;
return false;
}}
}
});
...
var vec__39565 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39565,(0),null);
var name = cljs.core.nth.call(null,vec__39565,(1),null);
...
return cljs.core.some.call(null,(function (p1__39568_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39568_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1513400459323
