...
var len__28365__auto___43376 = arguments.length;
var i__28366__auto___43377 = (0);
while(true){
if((i__28366__auto___43377 < len__28365__auto___43376)){
args__28372__auto__.push((arguments[i__28366__auto___43377]));

var G__43378 = (i__28366__auto___43377 + (1));
i__28366__auto___43377 = G__43378;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28373__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43373){
var G__43374 = cljs.core.first.call(null,seq43373);
var seq43373__$1 = cljs.core.next.call(null,seq43373);
var G__43375 = cljs.core.first.call(null,seq43373__$1);
var seq43373__$2 = cljs.core.next.call(null,seq43373__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__43374,G__43375,seq43373__$2);
});
...
if(cljs.core.truth_((function (){var or__27196__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__27821__auto__,writer__27822__auto__,opt__27823__auto__){
return cljs.core._write.call(null,writer__27822__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__27184__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__27184__auto__){
var or__27196__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43379_SHARP_){
return !((cljs.core.meta.call(null,p1__43379_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__43380__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__27196__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e43384){var _e__42396__auto__ = e43384;
return false;
}})();
if(cljs.core.truth_(or__27196__auto__)){
return or__27196__auto__;
...
}catch (e43386){var _e__42396__auto__ = e43386;
return false;
}}
})())){
...
var _STAR_current_state_STAR_43388 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__43389 = opts;
...
var markup_db = cljs.core.get.call(null,map__43389__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_43388;
}});
...
;
var temp__4655__auto___43393 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___43393)){
var managed_print_level_43394 = temp__4655__auto___43393;
var _STAR_print_level_STAR_43392_43395 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_43394;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_43392_43395,managed_print_level_43394,temp__4655__auto___43393,writer,opts,job_fn){
return (function (p1__43391_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__43391_SHARP_,null);
});})(_STAR_print_level_STAR_43392_43395,managed_print_level_43394,temp__4655__auto___43393,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_43392_43395;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1514660185761
