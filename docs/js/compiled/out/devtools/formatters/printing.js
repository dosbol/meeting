...
var len__28364__auto___43374 = arguments.length;
var i__28365__auto___43375 = (0);
while(true){
if((i__28365__auto___43375 < len__28364__auto___43374)){
args__28371__auto__.push((arguments[i__28365__auto___43375]));

var G__43376 = (i__28365__auto___43375 + (1));
i__28365__auto___43375 = G__43376;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43371){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__43372,G__43373,seq43371__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43377_SHARP_){
return !((cljs.core.meta.call(null,p1__43377_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__43378__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43382){var _e__42394__auto__ = e43382;
return false;
}})();
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
...
}catch (e43384){var _e__42394__auto__ = e43384;
return false;
}}
})())){
...
var _STAR_current_state_STAR_43386 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__43387 = opts;
...
var markup_db = cljs.core.get.call(null,map__43387__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_43386;
}});
...
;
var temp__4655__auto___43391 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___43391)){
var managed_print_level_43392 = temp__4655__auto___43391;
var _STAR_print_level_STAR_43390_43393 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_43392;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_43390_43393,managed_print_level_43392,temp__4655__auto___43391,writer,opts,job_fn){
return (function (p1__43389_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__43389_SHARP_,null);
});})(_STAR_print_level_STAR_43390_43393,managed_print_level_43392,temp__4655__auto___43391,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_43390_43393;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1515054952099
