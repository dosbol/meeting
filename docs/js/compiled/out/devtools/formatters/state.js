...
var len__28365__auto___43367 = arguments.length;
var i__28366__auto___43368 = (0);
while(true){
if((i__28366__auto___43368 < len__28365__auto___43367)){
args__28372__auto__.push((arguments[i__28366__auto___43368]));

var G__43369 = (i__28366__auto___43368 + (1));
i__28366__auto___43368 = G__43369;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28373__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq43365){
var G__43366 = cljs.core.first.call(null,seq43365);
var seq43365__$1 = cljs.core.next.call(null,seq43365);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__43366,seq43365__$1);
});
...
return (p1__43370_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1514660185517
