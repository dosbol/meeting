...
var len__28366__auto___43371 = arguments.length;
var i__28367__auto___43372 = (0);
while(true){
if((i__28367__auto___43372 < len__28366__auto___43371)){
args__28373__auto__.push((arguments[i__28367__auto___43372]));

var G__43373 = (i__28367__auto___43372 + (1));
i__28367__auto___43372 = G__43373;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28374__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq43369){
var G__43370 = cljs.core.first.call(null,seq43369);
var seq43369__$1 = cljs.core.next.call(null,seq43369);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__43370,seq43369__$1);
});
...
return (p1__43374_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1515350530968
