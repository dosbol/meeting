...
}catch (e46116){var _e = e46116;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___46119 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___46119)){
var seen_errors_46120 = temp__4655__auto___46119;
if(cljs.core.truth_(seen_errors_46120.has(self))){
} else {
seen_errors_46120.add(self);

var temp__4657__auto___46121 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___46121)){
var sense_46122 = temp__4657__auto___46121;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46122)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1516053544075
