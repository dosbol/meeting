...
var map__46124 = top_item;
var map__46124__$1 = ((((!((map__46124 == null)))?((((map__46124.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46124.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46124):map__46124);
var file = cljs.core.get.call(null,map__46124__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__46124__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__46124__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e46123){var _e = e46123;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___46126 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___46126)){
var seen_errors_46127 = temp__4655__auto___46126;
if(cljs.core.truth_(seen_errors_46127.has(self))){
} else {
seen_errors_46127.add(self);

var temp__4657__auto___46128 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___46128)){
var sense_46129 = temp__4657__auto___46128;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46129)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1516093644972
