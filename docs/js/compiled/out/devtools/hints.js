...
}catch (e46044){var _e = e46044;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___46047 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___46047)){
var seen_errors_46048 = temp__4655__auto___46047;
if(cljs.core.truth_(seen_errors_46048.has(self))){
} else {
seen_errors_46048.add(self);

var temp__4657__auto___46049 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___46049)){
var sense_46050 = temp__4657__auto___46049;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46050)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1515054971254
