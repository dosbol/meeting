...
}catch (e46119){var _e = e46119;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___46122 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___46122)){
var seen_errors_46123 = temp__4655__auto___46122;
if(cljs.core.truth_(seen_errors_46123.has(self))){
} else {
seen_errors_46123.add(self);

var temp__4657__auto___46124 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___46124)){
var sense_46125 = temp__4657__auto___46124;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46125)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1517373839736
