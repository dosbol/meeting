...
var map__45553 = top_item;
var map__45553__$1 = ((((!((map__45553 == null)))?((((map__45553.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45553.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45553):map__45553);
var file = cljs.core.get.call(null,map__45553__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__45553__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__45553__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e45552){var _e = e45552;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___45555 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___45555)){
var seen_errors_45556 = temp__4655__auto___45555;
if(cljs.core.truth_(seen_errors_45556.has(self))){
} else {
seen_errors_45556.add(self);

var temp__4657__auto___45557 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___45557)){
var sense_45558 = temp__4657__auto___45557;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_45558)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1512672449329
