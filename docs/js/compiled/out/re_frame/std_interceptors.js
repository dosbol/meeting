...
var vec__45436_45439 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_45440 = cljs.core.nth.call(null,vec__45436_45439,(0),null);
var only_after_45441 = cljs.core.nth.call(null,vec__45436_45439,(1),null);
var db_changed_QMARK__45442 = (!((only_before_45440 == null))) || (!((only_after_45441 == null)));
if(db_changed_QMARK__45442){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_45440);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_45441);
...
var map__45443 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__45443__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__45443__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__45445 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__45445__$1 = ((((!((map__45445 == null)))?((((map__45445.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45445.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45445):map__45445);
var coeffects = map__45445__$1;
var event = cljs.core.get.call(null,map__45445__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28364__auto___45448 = arguments.length;
var i__28365__auto___45449 = (0);
while(true){
if((i__28365__auto___45449 < len__28364__auto___45448)){
args__28371__auto__.push((arguments[i__28365__auto___45449]));

var G__45450 = (i__28365__auto___45449 + (1));
i__28365__auto___45449 = G__45450;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq45447){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45447));
});
...
var args__28371__auto__ = [];
var len__28364__auto___45456 = arguments.length;
var i__28365__auto___45457 = (0);
while(true){
if((i__28365__auto___45457 < len__28364__auto___45456)){
args__28371__auto__.push((arguments[i__28365__auto___45457]));

var G__45458 = (i__28365__auto___45457 + (1));
i__28365__auto___45457 = G__45458;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__45451_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__45452_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__45452_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq45453){
var G__45454 = cljs.core.first.call(null,seq45453);
var seq45453__$1 = cljs.core.next.call(null,seq45453);
var G__45455 = cljs.core.first.call(null,seq45453__$1);
var seq45453__$2 = cljs.core.next.call(null,seq45453__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__45454,G__45455,seq45453__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1515855061965
