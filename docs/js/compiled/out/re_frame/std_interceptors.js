...
var vec__45422_45425 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_45426 = cljs.core.nth.call(null,vec__45422_45425,(0),null);
var only_after_45427 = cljs.core.nth.call(null,vec__45422_45425,(1),null);
var db_changed_QMARK__45428 = (!((only_before_45426 == null))) || (!((only_after_45427 == null)));
if(db_changed_QMARK__45428){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_45426);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_45427);
...
var map__45429 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__45429__$1 = ((((!((map__45429 == null)))?((((map__45429.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45429.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45429):map__45429);
var db = cljs.core.get.call(null,map__45429__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__45429__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__45431 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__45431__$1;
var event = cljs.core.get.call(null,map__45431__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28366__auto___45434 = arguments.length;
var i__28367__auto___45435 = (0);
while(true){
if((i__28367__auto___45435 < len__28366__auto___45434)){
args__28373__auto__.push((arguments[i__28367__auto___45435]));

var G__45436 = (i__28367__auto___45435 + (1));
i__28367__auto___45435 = G__45436;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__28374__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq45433){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45433));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__27196__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__28373__auto__ = [];
var len__28366__auto___45442 = arguments.length;
var i__28367__auto___45443 = (0);
while(true){
if((i__28367__auto___45443 < len__28366__auto___45442)){
args__28373__auto__.push((arguments[i__28367__auto___45443]));

var G__45444 = (i__28367__auto___45443 + (1));
i__28367__auto___45443 = G__45444;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28374__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__45437_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__45438_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__45438_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__27184__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq45439){
var G__45440 = cljs.core.first.call(null,seq45439);
var seq45439__$1 = cljs.core.next.call(null,seq45439);
var G__45441 = cljs.core.first.call(null,seq45439__$1);
var seq45439__$2 = cljs.core.next.call(null,seq45439__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__45440,G__45441,seq45439__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1515350552369
