...
var vec__43939_43942 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_43943 = cljs.core.nth.call(null,vec__43939_43942,(0),null);
var only_after_43944 = cljs.core.nth.call(null,vec__43939_43942,(1),null);
var db_changed_QMARK__43945 = (!((only_before_43943 == null))) || (!((only_after_43944 == null)));
if(db_changed_QMARK__43945){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_43943);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_43944);
...
var map__43946 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__43946__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__43946__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__43948 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__43948__$1 = ((((!((map__43948 == null)))?((((map__43948.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43948.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43948):map__43948);
var coeffects = map__43948__$1;
var event = cljs.core.get.call(null,map__43948__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28364__auto___43951 = arguments.length;
var i__28365__auto___43952 = (0);
while(true){
if((i__28365__auto___43952 < len__28364__auto___43951)){
args__28371__auto__.push((arguments[i__28365__auto___43952]));

var G__43953 = (i__28365__auto___43952 + (1));
i__28365__auto___43952 = G__43953;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq43950){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq43950));
});
...
var args__28371__auto__ = [];
var len__28364__auto___43959 = arguments.length;
var i__28365__auto___43960 = (0);
while(true){
if((i__28365__auto___43960 < len__28364__auto___43959)){
args__28371__auto__.push((arguments[i__28365__auto___43960]));

var G__43961 = (i__28365__auto___43960 + (1));
i__28365__auto___43960 = G__43961;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__43954_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__43955_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__43955_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq43956){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__43957,G__43958,seq43956__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1514289242968
