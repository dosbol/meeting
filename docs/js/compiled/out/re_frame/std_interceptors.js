...
var vec__45433_45436 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_45437 = cljs.core.nth.call(null,vec__45433_45436,(0),null);
var only_after_45438 = cljs.core.nth.call(null,vec__45433_45436,(1),null);
...
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_45437);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_45438);
...
var map__45440 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__45440__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__45440__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__45442 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__45442__$1;
var event = cljs.core.get.call(null,map__45442__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28364__auto___45445 = arguments.length;
var i__28365__auto___45446 = (0);
while(true){
if((i__28365__auto___45446 < len__28364__auto___45445)){
args__28371__auto__.push((arguments[i__28365__auto___45446]));

var G__45447 = (i__28365__auto___45446 + (1));
i__28365__auto___45446 = G__45447;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq45444){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45444));
});
...
var args__28371__auto__ = [];
var len__28364__auto___45453 = arguments.length;
var i__28365__auto___45454 = (0);
while(true){
if((i__28365__auto___45454 < len__28364__auto___45453)){
args__28371__auto__.push((arguments[i__28365__auto___45454]));

var G__45455 = (i__28365__auto___45454 + (1));
i__28365__auto___45454 = G__45455;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__45448_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__45449_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__45449_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq45450){
var G__45451 = cljs.core.first.call(null,seq45450);
var seq45450__$1 = cljs.core.next.call(null,seq45450);
var G__45452 = cljs.core.first.call(null,seq45450__$1);
var seq45450__$2 = cljs.core.next.call(null,seq45450__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__45451,G__45452,seq45450__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1515953311087
