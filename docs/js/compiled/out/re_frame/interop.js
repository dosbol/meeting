...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__42447 = cljs.core.instance_QMARK_;
var expr__42448 = reactive_val;
if(cljs.core.truth_(pred__42447.call(null,reagent.ratom.RAtom,expr__42448))){
return "ra";
} else {
if(cljs.core.truth_(pred__42447.call(null,reagent.ratom.RCursor,expr__42448))){
return "rc";
} else {
if(cljs.core.truth_(pred__42447.call(null,reagent.ratom.Reaction,expr__42448))){
return "rx";
} else {
if(cljs.core.truth_(pred__42447.call(null,reagent.ratom.Track,expr__42448))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1516093622577
