...
var G__37360 = o;
(G__37360[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__37361__delegate = function (args){
...
while (G__37362__i < G__37362__a.length) {G__37362__a[G__37362__i] = arguments[G__37362__i + 0]; ++G__37362__i;}
  args = new cljs.core.IndexedSeq(G__37362__a,0,null);
} 
return G__37361__delegate.call(this,args);};
G__37361.cljs$lang$maxFixedArity = 0;
G__37361.cljs$lang$applyTo = (function (arglist__37363){
var args = cljs.core.seq(arglist__37363);
return G__37361__delegate(args);
});
...
var G__37366 = jsprops;
(G__37366["defaultValue"] = value);

(G__37366["onChange"] = ((function (G__37366,v,value,on_change){
return (function (p1__37365_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__37365_SHARP_);
});})(G__37366,v,value,on_change))
);
...
var vec__37369 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__37369,(0),null);
var id = cljs.core.nth.call(null,vec__37369,(1),null);
var class$ = cljs.core.nth.call(null,vec__37369,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___37373 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___37373 == null)){
} else {
var key_37374 = temp__4661__auto___37373;
(jsprops["key"] = key_37374);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__37375 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__37375["name"] = c);
...
var len__28364__auto___37380 = arguments.length;
var i__28365__auto___37381 = (0);
while(true){
if((i__28365__auto___37381 < len__28364__auto___37380)){
args__28371__auto__.push((arguments[i__28365__auto___37381]));

var G__37382 = (i__28365__auto___37381 + (1));
i__28365__auto___37381 = G__37382;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37378){
var G__37379 = cljs.core.first.call(null,seq37378);
var seq37378__$1 = cljs.core.next.call(null,seq37378);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__37379,seq37378__$1);
});
...
break;
default:
var G__37385 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__37385;
continue;
...
var n__28140__auto___37387 = a.length;
var i_37388 = (0);
while(true){
if((i_37388 < n__28140__auto___37387)){
(a[i_37388] = reagent.impl.template.as_element.call(null,(a[i_37388])));

var G__37389 = (i_37388 + (1));
i_37388 = G__37389;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__28140__auto___37390 = a.length;
var i_37391 = (0);
while(true){
if((i_37391 < n__28140__auto___37390)){
var val_37392 = (a[i_37391]);
if((cljs.core.vector_QMARK_.call(null,val_37392)) && ((reagent.impl.template.key_from_vec.call(null,val_37392) == null))){
(o["no-key"] = true);
} else {
}

(a[i_37391] = reagent.impl.template.as_element.call(null,val_37392));

var G__37393 = (i_37391 + (1));
i_37391 = G__37393;
continue;
} else {
}
...
var ctx = ({});
var vec__37394 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__37394,(0),null);
var derefed = cljs.core.nth.call(null,vec__37394,(1),null);
...
var G__37397 = (cljs.core.count.call(null,argv) - first_child);
switch (G__37397) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__37397){
...
//# sourceMappingURL=template.js.map?rel=1514366058879
