...
var G__38940 = o;
(G__38940[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38941__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38941 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38942__i = 0, G__38942__a = new Array(arguments.length -  0);
while (G__38942__i < G__38942__a.length) {G__38942__a[G__38942__i] = arguments[G__38942__i + 0]; ++G__38942__i;}
  args = new cljs.core.IndexedSeq(G__38942__a,0,null);
} 
return G__38941__delegate.call(this,args);};
G__38941.cljs$lang$maxFixedArity = 0;
G__38941.cljs$lang$applyTo = (function (arglist__38943){
var args = cljs.core.seq(arglist__38943);
return G__38941__delegate(args);
});
...
var G__38946 = jsprops;
(G__38946["defaultValue"] = value);

(G__38946["onChange"] = ((function (G__38946,v,value,on_change){
return (function (p1__38945_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38945_SHARP_);
});})(G__38946,v,value,on_change))
);
...
var vec__38949 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38949,(0),null);
var id = cljs.core.nth.call(null,vec__38949,(1),null);
var class$ = cljs.core.nth.call(null,vec__38949,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___38953 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38953 == null)){
} else {
var key_38954 = temp__4661__auto___38953;
(jsprops["key"] = key_38954);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38955 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__38955["name"] = c);
...
var len__28364__auto___38960 = arguments.length;
var i__28365__auto___38961 = (0);
while(true){
if((i__28365__auto___38961 < len__28364__auto___38960)){
args__28371__auto__.push((arguments[i__28365__auto___38961]));

var G__38962 = (i__28365__auto___38961 + (1));
i__28365__auto___38961 = G__38962;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38958){
var G__38959 = cljs.core.first.call(null,seq38958);
var seq38958__$1 = cljs.core.next.call(null,seq38958);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38959,seq38958__$1);
});
...
break;
default:
var G__38965 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38965;
continue;
...
var n__28140__auto___38967 = a.length;
var i_38968 = (0);
while(true){
if((i_38968 < n__28140__auto___38967)){
(a[i_38968] = reagent.impl.template.as_element.call(null,(a[i_38968])));
...
var a = cljs.core.into_array.call(null,s);
var n__28140__auto___38970 = a.length;
var i_38971 = (0);
while(true){
if((i_38971 < n__28140__auto___38970)){
var val_38972 = (a[i_38971]);
if((cljs.core.vector_QMARK_.call(null,val_38972)) && ((reagent.impl.template.key_from_vec.call(null,val_38972) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38971] = reagent.impl.template.as_element.call(null,val_38972));

var G__38973 = (i_38971 + (1));
i_38971 = G__38973;
continue;
} else {
}
...
var ctx = ({});
var vec__38974 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38974,(0),null);
var derefed = cljs.core.nth.call(null,vec__38974,(1),null);
...
var G__38977 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38977) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38977){
...
//# sourceMappingURL=template.js.map?rel=1516053497004
