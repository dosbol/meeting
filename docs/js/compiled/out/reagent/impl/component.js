...
if((i < len)){
var k = (ks[i]);
var G__38828 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__38829 = (i + (1));
m = G__38828;
i = G__38829;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__38831 = c;
var G__38831__$1 = (((G__38831 == null))?null:G__38831.prototype);
if((G__38831__$1 == null)){
return null;
} else {
return (G__38831__$1["reagentRender"]);
}
})() == null)));
});
...
return (function() { 
var G__38836__delegate = function (args){
...
while (G__38837__i < G__38837__a.length) {G__38837__a[G__38837__i] = arguments[G__38837__i + 0]; ++G__38837__i;}
  args = new cljs.core.IndexedSeq(G__38837__a,0,null);
} 
...
var _STAR_current_component_STAR_38840 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_38840;
}});
...
return ((function (G__38841,G__38841__$1){
...
var c = this;
var G__38842_38844 = (c["cljsRatom"]);
if((G__38842_38844 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__38842_38844);
}
...
var renders_38846 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38847 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_38846));
if((cljs.core.count.call(null,renders_38846) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_38846))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_38847)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_38847))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__38845 = name;
switch (G__38845) {
case "":
...
var G__38849 = o;
(G__38849[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__38850 = (function (){var or__27195__auto__ = (function (){var G__38852 = c;
if((G__38852 == null)){
return null;
} else {
return (G__38852["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
...
return (G__38850["_currentElement"]);
}
})();
var name = (function (){var G__38853 = elem;
var G__38853__$1 = (((G__38853 == null))?null:(G__38853["type"]));
if((G__38853__$1 == null)){
return null;
} else {
return (G__38853__$1["displayName"]);
}
})();
var path = (function (){var G__38854 = elem;
var G__38854__$1 = (((G__38854 == null))?null:(G__38854["_owner"]));
var G__38854__$2 = (((G__38854__$1 == null))?null:reagent.impl.component.component_path.call(null,G__38854__$1));
if((G__38854__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38854__$2)," > "].join('');
}
})();
...
var G__38855 = c;
var G__38855__$1 = (((G__38855 == null))?null:G__38855.constructor);
if((G__38855__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__38855__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1515054916035
